 ...
 * 
 * @export
 * @interface ListResponseBody12
 */
export interface ListResponseBody12 {
    /**
     * 
     * @type {Array<SeverityV2>}
     * @memberof ListResponseBody12
     */
    severities: Array<SeverityV2>;
}

/**
 * Check if a given object implements the ListResponseBody12 interface.
 */
export function instanceOfListResponseBody12(value: object): boolean {
    let isInstance = true;
...
export function ListResponseBody12FromJSON(json: any): ListResponseBody12 {
    return ListResponseBody12FromJSONTyped(json, false);
}

export function ListResponseBody12FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody12 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'severities': ((json['severities'] as Array<any>).map(SeverityV2FromJSON)),
    };
}

export function ListResponseBody12ToJSON(value?: ListResponseBody12 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'severities': ((value.severities as Array<any>).map(SeverityV2ToJSON)),
    };
}
