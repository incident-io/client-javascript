...
export type UserV1RoleEnum = typeof UserV1RoleEnum[keyof typeof UserV1RoleEnum];


/**
 * Check if a given object implements the UserV1 interface.
 */
export function instanceOfUserV1(value: object): boolean {
    let isInstance = true;
...
export function UserV1FromJSON(json: any): UserV1 {
    return UserV1FromJSONTyped(json, false);
}

export function UserV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): UserV1 {
...
export function UserV1ToJSON(value?: UserV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
