...
import type { CatalogResourceV2 } from './CatalogResourceV2';
import {
    CatalogResourceV2FromJSON,
    CatalogResourceV2FromJSONTyped,
    CatalogResourceV2ToJSON,
} from './CatalogResourceV2';

/**
 * 
 * @export
 * @interface ListResourcesResponseBody
 */
export interface ListResourcesResponseBody {
    /**
     * 
     * @type {Array<CatalogResourceV2>}
     * @memberof ListResourcesResponseBody
     */
    resources: Array<CatalogResourceV2>;
}

/**
 * Check if a given object implements the ListResourcesResponseBody interface.
 */
export function instanceOfListResourcesResponseBody(value: object): boolean {
    let isInstance = true;
...
export function ListResourcesResponseBodyFromJSON(json: any): ListResourcesResponseBody {
    return ListResourcesResponseBodyFromJSONTyped(json, false);
}

export function ListResourcesResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResourcesResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'resources': ((json['resources'] as Array<any>).map(CatalogResourceV2FromJSON)),
    };
}

export function ListResourcesResponseBodyToJSON(value?: ListResourcesResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'resources': ((value.resources as Array<any>).map(CatalogResourceV2ToJSON)),
    };
}
