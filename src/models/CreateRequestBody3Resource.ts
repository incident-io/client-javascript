 ...
 * 
 * @export
 * @interface CreateRequestBody3Resource
 */
export interface CreateRequestBody3Resource {
    /**
     * ID of the resource in the external system
     * @type {string}
     * @memberof CreateRequestBody3Resource
     */
    external_id: string;
    /**
     ...
     * @memberof CreateRequestBody3Resource
     */
    resource_type: CreateRequestBody3ResourceResourceTypeEnum;
}
 ...
 * @export
 */
export const CreateRequestBody3ResourceResourceTypeEnum = {
...
export type CreateRequestBody3ResourceResourceTypeEnum = typeof CreateRequestBody3ResourceResourceTypeEnum[keyof typeof CreateRequestBody3ResourceResourceTypeEnum];


/**
 * Check if a given object implements the CreateRequestBody3Resource interface.
 */
export function instanceOfCreateRequestBody3Resource(value: object): boolean {
    let isInstance = true;
...
export function CreateRequestBody3ResourceFromJSON(json: any): CreateRequestBody3Resource {
    return CreateRequestBody3ResourceFromJSONTyped(json, false);
}

export function CreateRequestBody3ResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRequestBody3Resource {
...
export function CreateRequestBody3ResourceToJSON(value?: CreateRequestBody3Resource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
