...
import type { UserReferencePayloadV1 } from './UserReferencePayloadV1';
import {
    UserReferencePayloadV1FromJSON,
    UserReferencePayloadV1FromJSONTyped,
    UserReferencePayloadV1ToJSON,
} from './UserReferencePayloadV1';

/**
 * 
 * @export
 * @interface IncidentRoleAssignmentPayloadV2
 */
export interface IncidentRoleAssignmentPayloadV2 {
    /**
     * 
     * @type {UserReferencePayloadV1}
     * @memberof IncidentRoleAssignmentPayloadV2
     */
...
/**
 * Check if a given object implements the IncidentRoleAssignmentPayloadV2 interface.
 */
export function instanceOfIncidentRoleAssignmentPayloadV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_role_id" in value;

    return isInstance;
}

export function IncidentRoleAssignmentPayloadV2FromJSON(json: any): IncidentRoleAssignmentPayloadV2 {
    return IncidentRoleAssignmentPayloadV2FromJSONTyped(json, false);
}

export function IncidentRoleAssignmentPayloadV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentRoleAssignmentPayloadV2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'assignee': !exists(json, 'assignee') ? undefined : UserReferencePayloadV1FromJSON(json['assignee']),
        'incident_role_id': json['incident_role_id'],
    };
}

export function IncidentRoleAssignmentPayloadV2ToJSON(value?: IncidentRoleAssignmentPayloadV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'assignee': UserReferencePayloadV1ToJSON(value.assignee),
