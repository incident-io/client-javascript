...
export interface UpdateEntryRequestBody {
     ...
     * @type {Array<string>}
     * @memberof UpdateEntryRequestBody
     */
...
/**
 * Check if a given object implements the UpdateEntryRequestBody interface.
 */
export function instanceOfUpdateEntryRequestBody(value: object): boolean {
    let isInstance = true;
...
export function UpdateEntryRequestBodyFromJSON(json: any): UpdateEntryRequestBody {
    return UpdateEntryRequestBodyFromJSONTyped(json, false);
}

export function UpdateEntryRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateEntryRequestBody {
...
export function UpdateEntryRequestBodyToJSON(value?: UpdateEntryRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
