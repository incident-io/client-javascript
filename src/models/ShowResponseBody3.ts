 ...
 * 
 * @export
 * @interface ShowResponseBody3
 */
export interface ShowResponseBody3 {
    /**
     * 
     * @type {CustomFieldV1}
     * @memberof ShowResponseBody3
     */
    custom_field: CustomFieldV1;
}

/**
 * Check if a given object implements the ShowResponseBody3 interface.
 */
export function instanceOfShowResponseBody3(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody3FromJSON(json: any): ShowResponseBody3 {
    return ShowResponseBody3FromJSONTyped(json, false);
}

export function ShowResponseBody3FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody3 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'custom_field': CustomFieldV1FromJSON(json['custom_field']),
    };
}

export function ShowResponseBody3ToJSON(value?: ShowResponseBody3 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'custom_field': CustomFieldV1ToJSON(value.custom_field),
    };
}
