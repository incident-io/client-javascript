 ...
 * 
 * @export
 * @interface ListResponseBody2
 */
export interface ListResponseBody2 {
    /**
     * 
     * @type {Array<CustomFieldOptionV1>}
     * @memberof ListResponseBody2
     */
    custom_field_options: Array<CustomFieldOptionV1>;
}

/**
 * Check if a given object implements the ListResponseBody2 interface.
 */
export function instanceOfListResponseBody2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "custom_field_options" in value;

    return isInstance;
}

export function ListResponseBody2FromJSON(json: any): ListResponseBody2 {
    return ListResponseBody2FromJSONTyped(json, false);
}

export function ListResponseBody2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'custom_field_options': ((json['custom_field_options'] as Array<any>).map(CustomFieldOptionV1FromJSON)),
    };
}

export function ListResponseBody2ToJSON(value?: ListResponseBody2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'custom_field_options': ((value.custom_field_options as Array<any>).map(CustomFieldOptionV1ToJSON)),
    };
}
