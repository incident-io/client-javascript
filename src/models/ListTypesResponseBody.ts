 ...
 * 
 * @export
 * @interface ListTypesResponseBody
 */
export interface ListTypesResponseBody {
    /**
     * 
     * @type {Array<CatalogTypeV2>}
     * @memberof ListTypesResponseBody
     */
    catalog_types: Array<CatalogTypeV2>;
}

/**
 * Check if a given object implements the ListTypesResponseBody interface.
 */
export function instanceOfListTypesResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "catalog_types" in value;

    return isInstance;
}

export function ListTypesResponseBodyFromJSON(json: any): ListTypesResponseBody {
    return ListTypesResponseBodyFromJSONTyped(json, false);
}

export function ListTypesResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTypesResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'catalog_types': ((json['catalog_types'] as Array<any>).map(CatalogTypeV2FromJSON)),
    };
}

export function ListTypesResponseBodyToJSON(value?: ListTypesResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'catalog_types': ((value.catalog_types as Array<any>).map(CatalogTypeV2ToJSON)),
    };
}
