 ...
 * 
 * @export
 * @interface UpdateTypeRequestBody
 */
export interface UpdateTypeRequestBody {
    /**
     * Annotations that can track metadata about this type
     * @type {{ [key: string]: string; }}
     * @memberof UpdateTypeRequestBody
     */
     ...
     * @memberof UpdateTypeRequestBody
     */
    color?: UpdateTypeRequestBodyColorEnum;
    /**
     ...
     * @memberof UpdateTypeRequestBody
     */
    icon?: UpdateTypeRequestBodyIconEnum;
    /**
 ...
 * @export
 */
export const UpdateTypeRequestBodyColorEnum = {
    Slate: 'slate',
    Red: 'red',
    Yellow: 'yellow',
    Green: 'green',
...
export type UpdateTypeRequestBodyColorEnum = typeof UpdateTypeRequestBodyColorEnum[keyof typeof UpdateTypeRequestBodyColorEnum];

/**
 * @export
 */
export const UpdateTypeRequestBodyIconEnum = {
    Bolt: 'bolt',
    Box: 'box',
    Briefcase: 'briefcase',
    Browser: 'browser',
...
export type UpdateTypeRequestBodyIconEnum = typeof UpdateTypeRequestBodyIconEnum[keyof typeof UpdateTypeRequestBodyIconEnum];


/**
 * Check if a given object implements the UpdateTypeRequestBody interface.
 */
export function instanceOfUpdateTypeRequestBody(value: object): boolean {
    let isInstance = true;
...
export function UpdateTypeRequestBodyFromJSON(json: any): UpdateTypeRequestBody {
    return UpdateTypeRequestBodyFromJSONTyped(json, false);
}

export function UpdateTypeRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateTypeRequestBody {
...
export function UpdateTypeRequestBodyToJSON(value?: UpdateTypeRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
