 ...
 * 
 * @export
 * @interface ShowResponseBody4
 */
export interface ShowResponseBody4 {
    /**
     * 
     * @type {IncidentRoleV1}
     * @memberof ShowResponseBody4
     */
    incident_role: IncidentRoleV1;
}

/**
 * Check if a given object implements the ShowResponseBody4 interface.
 */
export function instanceOfShowResponseBody4(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_role" in value;

    return isInstance;
}

export function ShowResponseBody4FromJSON(json: any): ShowResponseBody4 {
    return ShowResponseBody4FromJSONTyped(json, false);
}

export function ShowResponseBody4FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody4 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_role': IncidentRoleV1FromJSON(json['incident_role']),
    };
}

export function ShowResponseBody4ToJSON(value?: ShowResponseBody4 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_role': IncidentRoleV1ToJSON(value.incident_role),
    };
}
