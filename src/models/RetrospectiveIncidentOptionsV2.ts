 ...
 * 
 * @export
 * @interface RetrospectiveIncidentOptionsV2
 */
export interface RetrospectiveIncidentOptionsV2 {
    /**
     * If the incident mode is 'retrospective', pass the ID of a Slack channel in your workspace to attach the incident to an existing channel, rather than creating a new one
     * @type {string}
     * @memberof RetrospectiveIncidentOptionsV2
     */
    slack_channel_id?: string;
}

/**
 * Check if a given object implements the RetrospectiveIncidentOptionsV2 interface.
 */
export function instanceOfRetrospectiveIncidentOptionsV2(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RetrospectiveIncidentOptionsV2FromJSON(json: any): RetrospectiveIncidentOptionsV2 {
    return RetrospectiveIncidentOptionsV2FromJSONTyped(json, false);
}

export function RetrospectiveIncidentOptionsV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): RetrospectiveIncidentOptionsV2 {
...
export function RetrospectiveIncidentOptionsV2ToJSON(value?: RetrospectiveIncidentOptionsV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
