...
export interface ExternalIssueReferenceV1 {
     ...
     * @memberof ExternalIssueReferenceV1
     */
    provider?: ExternalIssueReferenceV1ProviderEnum;
}
 ...
 * @export
 */
export const ExternalIssueReferenceV1ProviderEnum = {
    Asana: 'asana',
    Linear: 'linear',
    Jira: 'jira',
...
export type ExternalIssueReferenceV1ProviderEnum = typeof ExternalIssueReferenceV1ProviderEnum[keyof typeof ExternalIssueReferenceV1ProviderEnum];


/**
 * Check if a given object implements the ExternalIssueReferenceV1 interface.
 */
export function instanceOfExternalIssueReferenceV1(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ExternalIssueReferenceV1FromJSON(json: any): ExternalIssueReferenceV1 {
    return ExternalIssueReferenceV1FromJSONTyped(json, false);
}

export function ExternalIssueReferenceV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalIssueReferenceV1 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'issue_name': !exists(json, 'issue_name') ? undefined : json['issue_name'],
        'issue_permalink': !exists(json, 'issue_permalink') ? undefined : json['issue_permalink'],
        'provider': !exists(json, 'provider') ? undefined : json['provider'],
    };
}

export function ExternalIssueReferenceV1ToJSON(value?: ExternalIssueReferenceV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
