...
import type { CatalogTypeAttributePayloadV2 } from './CatalogTypeAttributePayloadV2';
import {
    CatalogTypeAttributePayloadV2FromJSON,
    CatalogTypeAttributePayloadV2FromJSONTyped,
    CatalogTypeAttributePayloadV2ToJSON,
} from './CatalogTypeAttributePayloadV2';

/**
 * 
 * @export
 * @interface UpdateTypeSchemaRequestBody
 */
export interface UpdateTypeSchemaRequestBody {
    /**
     * 
     * @type {Array<CatalogTypeAttributePayloadV2>}
     * @memberof UpdateTypeSchemaRequestBody
     */
...
/**
 * Check if a given object implements the UpdateTypeSchemaRequestBody interface.
 */
export function instanceOfUpdateTypeSchemaRequestBody(value: object): boolean {
    let isInstance = true;
...
export function UpdateTypeSchemaRequestBodyFromJSON(json: any): UpdateTypeSchemaRequestBody {
    return UpdateTypeSchemaRequestBodyFromJSONTyped(json, false);
}

export function UpdateTypeSchemaRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateTypeSchemaRequestBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'attributes': ((json['attributes'] as Array<any>).map(CatalogTypeAttributePayloadV2FromJSON)),
        'version': json['version'],
    };
}

export function UpdateTypeSchemaRequestBodyToJSON(value?: UpdateTypeSchemaRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'attributes': ((value.attributes as Array<any>).map(CatalogTypeAttributePayloadV2ToJSON)),
