 ...
 * 
 * @export
 * @interface ExternalIssueReferenceV2
 */
export interface ExternalIssueReferenceV2 {
    /**
     * Human readable ID for the issue
     * @type {string}
     * @memberof ExternalIssueReferenceV2
     */
    issue_name: string;
    /**
     ...
     * @memberof ExternalIssueReferenceV2
     */
    provider: ExternalIssueReferenceV2ProviderEnum;
}
 ...
 * @export
 */
export const ExternalIssueReferenceV2ProviderEnum = {
    Asana: 'asana',
    Linear: 'linear',
    Jira: 'jira',
...
export type ExternalIssueReferenceV2ProviderEnum = typeof ExternalIssueReferenceV2ProviderEnum[keyof typeof ExternalIssueReferenceV2ProviderEnum];


/**
 * Check if a given object implements the ExternalIssueReferenceV2 interface.
 */
export function instanceOfExternalIssueReferenceV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "issue_name" in value;
    isInstance = isInstance && "issue_permalink" in value;
    isInstance = isInstance && "provider" in value;

    return isInstance;
}

export function ExternalIssueReferenceV2FromJSON(json: any): ExternalIssueReferenceV2 {
    return ExternalIssueReferenceV2FromJSONTyped(json, false);
}

export function ExternalIssueReferenceV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalIssueReferenceV2 {
...
export function ExternalIssueReferenceV2ToJSON(value?: ExternalIssueReferenceV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
