...
import type { AuditLogUserSCIMGroupMappingChangedMetadataV2 } from './AuditLogUserSCIMGroupMappingChangedMetadataV2';
import {
    AuditLogUserSCIMGroupMappingChangedMetadataV2FromJSON,
    AuditLogUserSCIMGroupMappingChangedMetadataV2FromJSONTyped,
    AuditLogUserSCIMGroupMappingChangedMetadataV2ToJSON,
} from './AuditLogUserSCIMGroupMappingChangedMetadataV2';

/**
 * 
 * @export
 * @interface ScimGroupRoleMappingsUpdatedV1ResponseBody
 */
export interface ScimGroupRoleMappingsUpdatedV1ResponseBody {
    /**
     * The type of log entry that this is
     * @type {string}
     * @memberof ScimGroupRoleMappingsUpdatedV1ResponseBody
     */
    action: string;
    /**
     * 
    ...
    /**
     * 
     * @type {AuditLogUserSCIMGroupMappingChangedMetadataV2}
     * @memberof ScimGroupRoleMappingsUpdatedV1ResponseBody
     */
...
/**
 * Check if a given object implements the ScimGroupRoleMappingsUpdatedV1ResponseBody interface.
 */
export function instanceOfScimGroupRoleMappingsUpdatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
...
export function ScimGroupRoleMappingsUpdatedV1ResponseBodyFromJSON(json: any): ScimGroupRoleMappingsUpdatedV1ResponseBody {
    return ScimGroupRoleMappingsUpdatedV1ResponseBodyFromJSONTyped(json, false);
}

export function ScimGroupRoleMappingsUpdatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScimGroupRoleMappingsUpdatedV1ResponseBody {
    ...
    return {
        ...
        'metadata': AuditLogUserSCIMGroupMappingChangedMetadataV2FromJSON(json['metadata']),
...
export function ScimGroupRoleMappingsUpdatedV1ResponseBodyToJSON(value?: ScimGroupRoleMappingsUpdatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'metadata': AuditLogUserSCIMGroupMappingChangedMetadataV2ToJSON(value.metadata),
