...
export interface IdentityV1 {
     ...
     * @memberof IdentityV1
     */
    roles: Array<IdentityV1RolesEnum>;
}
 ...
 * @export
 */
export const IdentityV1RolesEnum = {
    Viewer: 'viewer',
...
export type IdentityV1RolesEnum = typeof IdentityV1RolesEnum[keyof typeof IdentityV1RolesEnum];


/**
 * Check if a given object implements the IdentityV1 interface.
 */
export function instanceOfIdentityV1(value: object): boolean {
    let isInstance = true;
...
export function IdentityV1FromJSON(json: any): IdentityV1 {
    return IdentityV1FromJSONTyped(json, false);
}

export function IdentityV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentityV1 {
...
export function IdentityV1ToJSON(value?: IdentityV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
