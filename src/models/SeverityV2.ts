...
/**
 * Check if a given object implements the SeverityV2 interface.
 */
export function instanceOfSeverityV2(value: object): boolean {
    let isInstance = true;
...
export function SeverityV2FromJSON(json: any): SeverityV2 {
    return SeverityV2FromJSONTyped(json, false);
}

export function SeverityV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): SeverityV2 {
...
export function SeverityV2ToJSON(value?: SeverityV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
