...
import type { CustomFieldV1 } from './CustomFieldV1';
import {
    CustomFieldV1FromJSON,
    CustomFieldV1FromJSONTyped,
    CustomFieldV1ToJSON,
} from './CustomFieldV1';
 ...
 * 
 * @export
 * @interface ListResponseBody3
 */
export interface ListResponseBody3 {
    /**
     * 
     * @type {Array<CustomFieldV1>}
     * @memberof ListResponseBody3
     */
    custom_fields: Array<CustomFieldV1>;
}

/**
 * Check if a given object implements the ListResponseBody3 interface.
 */
export function instanceOfListResponseBody3(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "custom_fields" in value;

    return isInstance;
}

export function ListResponseBody3FromJSON(json: any): ListResponseBody3 {
    return ListResponseBody3FromJSONTyped(json, false);
}

export function ListResponseBody3FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody3 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'custom_fields': ((json['custom_fields'] as Array<any>).map(CustomFieldV1FromJSON)),
    };
}

export function ListResponseBody3ToJSON(value?: ListResponseBody3 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'custom_fields': ((value.custom_fields as Array<any>).map(CustomFieldV1ToJSON)),
    };
}
