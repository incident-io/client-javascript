...
import type { CatalogEntryV2 } from './CatalogEntryV2';
import {
    CatalogEntryV2FromJSON,
    CatalogEntryV2FromJSONTyped,
    CatalogEntryV2ToJSON,
} from './CatalogEntryV2';
import type { CatalogTypeV2 } from './CatalogTypeV2';
import {
    CatalogTypeV2FromJSON,
    CatalogTypeV2FromJSONTyped,
    CatalogTypeV2ToJSON,
} from './CatalogTypeV2';
import type { PaginationMetaResult } from './PaginationMetaResult';
import {
    PaginationMetaResultFromJSON,
    PaginationMetaResultFromJSONTyped,
    PaginationMetaResultToJSON,
} from './PaginationMetaResult';

/**
 * 
 * @export
 * @interface ListEntriesResponseBody
 */
export interface ListEntriesResponseBody {
    /**
     * 
     * @type {Array<CatalogEntryV2>}
     * @memberof ListEntriesResponseBody
     */
...
/**
 * Check if a given object implements the ListEntriesResponseBody interface.
 */
export function instanceOfListEntriesResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "catalog_entries" in value;
    isInstance = isInstance && "catalog_type" in value;
    isInstance = isInstance && "pagination_meta" in value;

    return isInstance;
}

export function ListEntriesResponseBodyFromJSON(json: any): ListEntriesResponseBody {
    return ListEntriesResponseBodyFromJSONTyped(json, false);
}

export function ListEntriesResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListEntriesResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'catalog_entries': ((json['catalog_entries'] as Array<any>).map(CatalogEntryV2FromJSON)),
        'catalog_type': CatalogTypeV2FromJSON(json['catalog_type']),
        'pagination_meta': PaginationMetaResultFromJSON(json['pagination_meta']),
    };
}

export function ListEntriesResponseBodyToJSON(value?: ListEntriesResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'catalog_entries': ((value.catalog_entries as Array<any>).map(CatalogEntryV2ToJSON)),
        'catalog_type': CatalogTypeV2ToJSON(value.catalog_type),
        'pagination_meta': PaginationMetaResultToJSON(value.pagination_meta),
    };
}
