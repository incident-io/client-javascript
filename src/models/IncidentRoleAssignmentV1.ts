 ...
 * 
 * @export
 * @interface IncidentRoleAssignmentV1
 */
export interface IncidentRoleAssignmentV1 {
    /**
     * 
     * @type {UserV1}
     * @memberof IncidentRoleAssignmentV1
     */
    assignee?: UserV1;
    /**
     * 
...
/**
 * Check if a given object implements the IncidentRoleAssignmentV1 interface.
 */
export function instanceOfIncidentRoleAssignmentV1(value: object): boolean {
    let isInstance = true;
...
export function IncidentRoleAssignmentV1FromJSON(json: any): IncidentRoleAssignmentV1 {
    return IncidentRoleAssignmentV1FromJSONTyped(json, false);
}

export function IncidentRoleAssignmentV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentRoleAssignmentV1 {
    ...
    return {
        ...
        'role': IncidentRoleV1FromJSON(json['role']),
    };
}

export function IncidentRoleAssignmentV1ToJSON(value?: IncidentRoleAssignmentV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'role': IncidentRoleV1ToJSON(value.role),
    };
}
