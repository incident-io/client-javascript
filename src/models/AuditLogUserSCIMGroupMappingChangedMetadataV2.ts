 ...
 * 
 * @export
 * @interface AuditLogUserSCIMGroupMappingChangedMetadataV2
 */
export interface AuditLogUserSCIMGroupMappingChangedMetadataV2 {
     ...
     * @type {string}
     * @memberof AuditLogUserSCIMGroupMappingChangedMetadataV2
     */
...
/**
 * Check if a given object implements the AuditLogUserSCIMGroupMappingChangedMetadataV2 interface.
 */
export function instanceOfAuditLogUserSCIMGroupMappingChangedMetadataV2(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AuditLogUserSCIMGroupMappingChangedMetadataV2FromJSON(json: any): AuditLogUserSCIMGroupMappingChangedMetadataV2 {
    return AuditLogUserSCIMGroupMappingChangedMetadataV2FromJSONTyped(json, false);
}

export function AuditLogUserSCIMGroupMappingChangedMetadataV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditLogUserSCIMGroupMappingChangedMetadataV2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'after_base_role_slug': !exists(json, 'after_base_role_slug') ? undefined : json['after_base_role_slug'],
        'after_custom_role_slugs': !exists(json, 'after_custom_role_slugs') ? undefined : json['after_custom_role_slugs'],
        'before_base_role_slug': !exists(json, 'before_base_role_slug') ? undefined : json['before_base_role_slug'],
        'before_custom_role_slugs': !exists(json, 'before_custom_role_slugs') ? undefined : json['before_custom_role_slugs'],
    };
}

export function AuditLogUserSCIMGroupMappingChangedMetadataV2ToJSON(value?: AuditLogUserSCIMGroupMappingChangedMetadataV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
