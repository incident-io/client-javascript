...
import type { IncidentUpdateV2 } from './IncidentUpdateV2';
import {
    IncidentUpdateV2FromJSON,
    IncidentUpdateV2FromJSONTyped,
    IncidentUpdateV2ToJSON,
} from './IncidentUpdateV2';
 ...
 * 
 * @export
 * @interface ListResponseBody9
 */
export interface ListResponseBody9 {
    /**
     * 
     * @type {Array<IncidentUpdateV2>}
     * @memberof ListResponseBody9
     */
...
/**
 * Check if a given object implements the ListResponseBody9 interface.
 */
export function instanceOfListResponseBody9(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_updates" in value;

    return isInstance;
}

export function ListResponseBody9FromJSON(json: any): ListResponseBody9 {
    return ListResponseBody9FromJSONTyped(json, false);
}

export function ListResponseBody9FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody9 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_updates': ((json['incident_updates'] as Array<any>).map(IncidentUpdateV2FromJSON)),
        'pagination_meta': !exists(json, 'pagination_meta') ? undefined : PaginationMetaResultFromJSON(json['pagination_meta']),
    };
}

export function ListResponseBody9ToJSON(value?: ListResponseBody9 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_updates': ((value.incident_updates as Array<any>).map(IncidentUpdateV2ToJSON)),
