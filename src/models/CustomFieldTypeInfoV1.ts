 ...
 * 
 * @export
 * @interface CustomFieldTypeInfoV1
 */
export interface CustomFieldTypeInfoV1 {
    /**
     * Description of the custom field
     * @type {string}
     * @memberof CustomFieldTypeInfoV1
     */
    description: string;
    /**
     ...
     * @memberof CustomFieldTypeInfoV1
     */
    field_type: CustomFieldTypeInfoV1FieldTypeEnum;
    /**
 ...
 * @export
 */
export const CustomFieldTypeInfoV1FieldTypeEnum = {
...
export type CustomFieldTypeInfoV1FieldTypeEnum = typeof CustomFieldTypeInfoV1FieldTypeEnum[keyof typeof CustomFieldTypeInfoV1FieldTypeEnum];


/**
 * Check if a given object implements the CustomFieldTypeInfoV1 interface.
 */
export function instanceOfCustomFieldTypeInfoV1(value: object): boolean {
    let isInstance = true;
...
export function CustomFieldTypeInfoV1FromJSON(json: any): CustomFieldTypeInfoV1 {
    return CustomFieldTypeInfoV1FromJSONTyped(json, false);
}

export function CustomFieldTypeInfoV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldTypeInfoV1 {
...
export function CustomFieldTypeInfoV1ToJSON(value?: CustomFieldTypeInfoV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
