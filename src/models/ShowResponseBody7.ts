 ...
 * 
 * @export
 * @interface ShowResponseBody7
 */
export interface ShowResponseBody7 {
    /**
     * 
     * @type {IncidentTypeV1}
     * @memberof ShowResponseBody7
     */
    incident_type: IncidentTypeV1;
}

/**
 * Check if a given object implements the ShowResponseBody7 interface.
 */
export function instanceOfShowResponseBody7(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody7FromJSON(json: any): ShowResponseBody7 {
    return ShowResponseBody7FromJSONTyped(json, false);
}

export function ShowResponseBody7FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody7 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_type': IncidentTypeV1FromJSON(json['incident_type']),
    };
}

export function ShowResponseBody7ToJSON(value?: ShowResponseBody7 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
