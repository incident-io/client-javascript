...
import type { IncidentRoleV1 } from './IncidentRoleV1';
import {
    IncidentRoleV1FromJSON,
    IncidentRoleV1FromJSONTyped,
    IncidentRoleV1ToJSON,
} from './IncidentRoleV1';

/**
 * 
 * @export
 * @interface ListResponseBody5
 */
export interface ListResponseBody5 {
    /**
     * 
     * @type {Array<IncidentRoleV1>}
     * @memberof ListResponseBody5
     */
    incident_roles: Array<IncidentRoleV1>;
}

/**
 * Check if a given object implements the ListResponseBody5 interface.
 */
export function instanceOfListResponseBody5(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_roles" in value;

    return isInstance;
}

export function ListResponseBody5FromJSON(json: any): ListResponseBody5 {
    return ListResponseBody5FromJSONTyped(json, false);
}

export function ListResponseBody5FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody5 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_roles': ((json['incident_roles'] as Array<any>).map(IncidentRoleV1FromJSON)),
    };
}

export function ListResponseBody5ToJSON(value?: ListResponseBody5 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_roles': ((value.incident_roles as Array<any>).map(IncidentRoleV1ToJSON)),
    };
}
