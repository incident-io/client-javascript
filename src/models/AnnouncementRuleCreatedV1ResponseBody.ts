 ...
 * 
 * @export
 * @interface AnnouncementRuleCreatedV1ResponseBody
 */
export interface AnnouncementRuleCreatedV1ResponseBody {
    /**
     * The type of log entry that this is
     * @type {string}
     * @memberof AnnouncementRuleCreatedV1ResponseBody
     */
    action: string;
    /**
     * 
...
/**
 * Check if a given object implements the AnnouncementRuleCreatedV1ResponseBody interface.
 */
export function instanceOfAnnouncementRuleCreatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
...
export function AnnouncementRuleCreatedV1ResponseBodyFromJSON(json: any): AnnouncementRuleCreatedV1ResponseBody {
    return AnnouncementRuleCreatedV1ResponseBodyFromJSONTyped(json, false);
}

export function AnnouncementRuleCreatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnnouncementRuleCreatedV1ResponseBody {
...
export function AnnouncementRuleCreatedV1ResponseBodyToJSON(value?: AnnouncementRuleCreatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
