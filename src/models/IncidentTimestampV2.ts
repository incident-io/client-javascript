...
/**
 * Check if a given object implements the IncidentTimestampV2 interface.
 */
export function instanceOfIncidentTimestampV2(value: object): boolean {
    let isInstance = true;
...
export function IncidentTimestampV2FromJSON(json: any): IncidentTimestampV2 {
    return IncidentTimestampV2FromJSONTyped(json, false);
}

export function IncidentTimestampV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentTimestampV2 {
...
export function IncidentTimestampV2ToJSON(value?: IncidentTimestampV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
