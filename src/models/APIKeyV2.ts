...
/**
 * Check if a given object implements the APIKeyV2 interface.
 */
export function instanceOfAPIKeyV2(value: object): boolean {
    let isInstance = true;
...
export function APIKeyV2FromJSON(json: any): APIKeyV2 {
    return APIKeyV2FromJSONTyped(json, false);
}

export function APIKeyV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): APIKeyV2 {
...
export function APIKeyV2ToJSON(value?: APIKeyV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
