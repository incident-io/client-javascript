 ...
 * 
 * @export
 * @interface ShowResponseBody9
 */
export interface ShowResponseBody9 {
    /**
     * 
     * @type {IncidentV2}
     * @memberof ShowResponseBody9
     */
    incident: IncidentV2;
}

/**
 * Check if a given object implements the ShowResponseBody9 interface.
 */
export function instanceOfShowResponseBody9(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody9FromJSON(json: any): ShowResponseBody9 {
    return ShowResponseBody9FromJSONTyped(json, false);
}

export function ShowResponseBody9FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody9 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident': IncidentV2FromJSON(json['incident']),
    };
}

export function ShowResponseBody9ToJSON(value?: ShowResponseBody9 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident': IncidentV2ToJSON(value.incident),
    };
}
