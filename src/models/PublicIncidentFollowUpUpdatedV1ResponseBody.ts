 ...
 * 
 * @export
 * @interface PublicIncidentFollowUpUpdatedV1ResponseBody
 */
export interface PublicIncidentFollowUpUpdatedV1ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PublicIncidentFollowUpUpdatedV1ResponseBody
     */
    event_type: PublicIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum;
    /**
     * 
     * @type {ActionV1}
     * @memberof PublicIncidentFollowUpUpdatedV1ResponseBody
 ...
 * @export
 */
export const PublicIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum = {
...
export type PublicIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum = typeof PublicIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum[keyof typeof PublicIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PublicIncidentFollowUpUpdatedV1ResponseBody interface.
 */
export function instanceOfPublicIncidentFollowUpUpdatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "public_incident_follow_up_updated_v1" in value;

    return isInstance;
}

export function PublicIncidentFollowUpUpdatedV1ResponseBodyFromJSON(json: any): PublicIncidentFollowUpUpdatedV1ResponseBody {
    return PublicIncidentFollowUpUpdatedV1ResponseBodyFromJSONTyped(json, false);
}

export function PublicIncidentFollowUpUpdatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicIncidentFollowUpUpdatedV1ResponseBody {
    ...
    return {
        ...
        'public_incident_follow_up_updated_v1': ActionV1FromJSON(json['public_incident.follow_up_updated_v1']),
    };
}

export function PublicIncidentFollowUpUpdatedV1ResponseBodyToJSON(value?: PublicIncidentFollowUpUpdatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
