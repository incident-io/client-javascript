 ...
 * 
 * @export
 * @interface AuditLogUserRoleMembershipChangedMetadataV2
 */
export interface AuditLogUserRoleMembershipChangedMetadataV2 {
     ...
     * @type {string}
     * @memberof AuditLogUserRoleMembershipChangedMetadataV2
     */
...
/**
 * Check if a given object implements the AuditLogUserRoleMembershipChangedMetadataV2 interface.
 */
export function instanceOfAuditLogUserRoleMembershipChangedMetadataV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "after_base_role_slug" in value;
    isInstance = isInstance && "after_custom_role_slugs" in value;
    isInstance = isInstance && "before_base_role_slug" in value;
    isInstance = isInstance && "before_custom_role_slugs" in value;

    return isInstance;
}

export function AuditLogUserRoleMembershipChangedMetadataV2FromJSON(json: any): AuditLogUserRoleMembershipChangedMetadataV2 {
    return AuditLogUserRoleMembershipChangedMetadataV2FromJSONTyped(json, false);
}

export function AuditLogUserRoleMembershipChangedMetadataV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditLogUserRoleMembershipChangedMetadataV2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'after_base_role_slug': json['after_base_role_slug'],
        'after_custom_role_slugs': json['after_custom_role_slugs'],
        'before_base_role_slug': json['before_base_role_slug'],
        'before_custom_role_slugs': json['before_custom_role_slugs'],
    };
}

export function AuditLogUserRoleMembershipChangedMetadataV2ToJSON(value?: AuditLogUserRoleMembershipChangedMetadataV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'after_base_role_slug': value.after_base_role_slug,
        'after_custom_role_slugs': value.after_custom_role_slugs,
        'before_base_role_slug': value.before_base_role_slug,
        'before_custom_role_slugs': value.before_custom_role_slugs,
    };
}
