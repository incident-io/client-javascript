 ...
 * 
 * @export
 * @interface ShowResponseBody2
 */
export interface ShowResponseBody2 {
    /**
     * 
     * @type {CustomFieldOptionV1}
     * @memberof ShowResponseBody2
     */
    custom_field_option: CustomFieldOptionV1;
}

/**
 * Check if a given object implements the ShowResponseBody2 interface.
 */
export function instanceOfShowResponseBody2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "custom_field_option" in value;

    return isInstance;
}

export function ShowResponseBody2FromJSON(json: any): ShowResponseBody2 {
    return ShowResponseBody2FromJSONTyped(json, false);
}

export function ShowResponseBody2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'custom_field_option': CustomFieldOptionV1FromJSON(json['custom_field_option']),
    };
}

export function ShowResponseBody2ToJSON(value?: ShowResponseBody2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'custom_field_option': CustomFieldOptionV1ToJSON(value.custom_field_option),
    };
}
