...
/**
 * Check if a given object implements the CatalogTypeAttributePayloadV2 interface.
 */
export function instanceOfCatalogTypeAttributePayloadV2(value: object): boolean {
    let isInstance = true;
...
export function CatalogTypeAttributePayloadV2FromJSON(json: any): CatalogTypeAttributePayloadV2 {
    return CatalogTypeAttributePayloadV2FromJSONTyped(json, false);
}

export function CatalogTypeAttributePayloadV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogTypeAttributePayloadV2 {
...
export function CatalogTypeAttributePayloadV2ToJSON(value?: CatalogTypeAttributePayloadV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
