...
export interface CreateResponseBody {
     ...
     * @memberof CreateResponseBody
     */
    incident_attachment: IncidentAttachmentV1;
}

/**
 * Check if a given object implements the CreateResponseBody interface.
 */
export function instanceOfCreateResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_attachment" in value;

    return isInstance;
}

export function CreateResponseBodyFromJSON(json: any): CreateResponseBody {
    return CreateResponseBodyFromJSONTyped(json, false);
}

export function CreateResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_attachment': IncidentAttachmentV1FromJSON(json['incident_attachment']),
    };
}

export function CreateResponseBodyToJSON(value?: CreateResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_attachment': IncidentAttachmentV1ToJSON(value.incident_attachment),
    };
}
