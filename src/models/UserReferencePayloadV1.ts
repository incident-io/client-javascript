...
/**
 * Check if a given object implements the UserReferencePayloadV1 interface.
 */
export function instanceOfUserReferencePayloadV1(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UserReferencePayloadV1FromJSON(json: any): UserReferencePayloadV1 {
    return UserReferencePayloadV1FromJSONTyped(json, false);
}

export function UserReferencePayloadV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): UserReferencePayloadV1 {
...
export function UserReferencePayloadV1ToJSON(value?: UserReferencePayloadV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
