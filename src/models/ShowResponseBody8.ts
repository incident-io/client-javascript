 ...
 * 
 * @export
 * @interface ShowResponseBody8
 */
export interface ShowResponseBody8 {
    /**
     * 
     * @type {IncidentV1}
     * @memberof ShowResponseBody8
     */
    incident: IncidentV1;
}

/**
 * Check if a given object implements the ShowResponseBody8 interface.
 */
export function instanceOfShowResponseBody8(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody8FromJSON(json: any): ShowResponseBody8 {
    return ShowResponseBody8FromJSONTyped(json, false);
}

export function ShowResponseBody8FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody8 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident': IncidentV1FromJSON(json['incident']),
    };
}

export function ShowResponseBody8ToJSON(value?: ShowResponseBody8 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident': IncidentV1ToJSON(value.incident),
    };
}
