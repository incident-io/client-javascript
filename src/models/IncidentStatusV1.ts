 ...
 * 
 * @export
 * @interface IncidentStatusV1
 */
export interface IncidentStatusV1 {
    /**
     * Whether this status is a live or closed status. If you have enabled auto-create, there will also be 'triage' and 'declined' statuses, which cannot be modified.
     * @type {string}
     * @memberof IncidentStatusV1
     */
    category: IncidentStatusV1CategoryEnum;
    /**
     * 
     * @type {Date}
     * @memberof IncidentStatusV1
 ...
 * @export
 */
export const IncidentStatusV1CategoryEnum = {
    Triage: 'triage',
    Declined: 'declined',
    Merged: 'merged',
    Live: 'live',
...
export type IncidentStatusV1CategoryEnum = typeof IncidentStatusV1CategoryEnum[keyof typeof IncidentStatusV1CategoryEnum];


/**
 * Check if a given object implements the IncidentStatusV1 interface.
 */
export function instanceOfIncidentStatusV1(value: object): boolean {
    let isInstance = true;
...
export function IncidentStatusV1FromJSON(json: any): IncidentStatusV1 {
    return IncidentStatusV1FromJSONTyped(json, false);
}

export function IncidentStatusV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentStatusV1 {
...
export function IncidentStatusV1ToJSON(value?: IncidentStatusV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
