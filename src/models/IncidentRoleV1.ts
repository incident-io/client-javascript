 ...
 * 
 * @export
 * @interface IncidentRoleV1
 */
export interface IncidentRoleV1 {
    /**
     * When the action was created
     * @type {Date}
     * @memberof IncidentRoleV1
     */
    created_at: Date;
    /**
     ...
     * @memberof IncidentRoleV1
     */
    role_type: IncidentRoleV1RoleTypeEnum;
    /**
 ...
 * @export
 */
export const IncidentRoleV1RoleTypeEnum = {
    Lead: 'lead',
    Reporter: 'reporter',
    Custom: 'custom'
} as const;
export type IncidentRoleV1RoleTypeEnum = typeof IncidentRoleV1RoleTypeEnum[keyof typeof IncidentRoleV1RoleTypeEnum];


/**
 * Check if a given object implements the IncidentRoleV1 interface.
 */
export function instanceOfIncidentRoleV1(value: object): boolean {
    let isInstance = true;
    ...
    isInstance = isInstance && "role_type" in value;
    isInstance = isInstance && "shortform" in value;
    isInstance = isInstance && "updated_at" in value;

    return isInstance;
}

export function IncidentRoleV1FromJSON(json: any): IncidentRoleV1 {
    return IncidentRoleV1FromJSONTyped(json, false);
}

export function IncidentRoleV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentRoleV1 {
...
export function IncidentRoleV1ToJSON(value?: IncidentRoleV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
