...
import type { AuditLogUserRoleMembershipChangedMetadataV2 } from './AuditLogUserRoleMembershipChangedMetadataV2';
import {
    AuditLogUserRoleMembershipChangedMetadataV2FromJSON,
    AuditLogUserRoleMembershipChangedMetadataV2FromJSONTyped,
    AuditLogUserRoleMembershipChangedMetadataV2ToJSON,
} from './AuditLogUserRoleMembershipChangedMetadataV2';

/**
 * 
 * @export
 * @interface UserRoleMembershipsUpdatedV1ResponseBody
 */
export interface UserRoleMembershipsUpdatedV1ResponseBody {
    /**
     * The type of log entry that this is
     * @type {string}
     * @memberof UserRoleMembershipsUpdatedV1ResponseBody
     */
    action: string;
    /**
     * 
    ...
    /**
     * 
     * @type {AuditLogUserRoleMembershipChangedMetadataV2}
     * @memberof UserRoleMembershipsUpdatedV1ResponseBody
     */
...
/**
 * Check if a given object implements the UserRoleMembershipsUpdatedV1ResponseBody interface.
 */
export function instanceOfUserRoleMembershipsUpdatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
...
export function UserRoleMembershipsUpdatedV1ResponseBodyFromJSON(json: any): UserRoleMembershipsUpdatedV1ResponseBody {
    return UserRoleMembershipsUpdatedV1ResponseBodyFromJSONTyped(json, false);
}

export function UserRoleMembershipsUpdatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserRoleMembershipsUpdatedV1ResponseBody {
    ...
    return {
        ...
        'metadata': AuditLogUserRoleMembershipChangedMetadataV2FromJSON(json['metadata']),
...
export function UserRoleMembershipsUpdatedV1ResponseBodyToJSON(value?: UserRoleMembershipsUpdatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'metadata': AuditLogUserRoleMembershipChangedMetadataV2ToJSON(value.metadata),
