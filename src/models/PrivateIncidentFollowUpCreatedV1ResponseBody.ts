 ...
 * 
 * @export
 * @interface PrivateIncidentFollowUpCreatedV1ResponseBody
 */
export interface PrivateIncidentFollowUpCreatedV1ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PrivateIncidentFollowUpCreatedV1ResponseBody
     */
    event_type: PrivateIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const PrivateIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum = {
...
export type PrivateIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum = typeof PrivateIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum[keyof typeof PrivateIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PrivateIncidentFollowUpCreatedV1ResponseBody interface.
 */
export function instanceOfPrivateIncidentFollowUpCreatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "private_incident_follow_up_created_v1" in value;

    return isInstance;
}

export function PrivateIncidentFollowUpCreatedV1ResponseBodyFromJSON(json: any): PrivateIncidentFollowUpCreatedV1ResponseBody {
    return PrivateIncidentFollowUpCreatedV1ResponseBodyFromJSONTyped(json, false);
}

export function PrivateIncidentFollowUpCreatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivateIncidentFollowUpCreatedV1ResponseBody {
    ...
    return {
        ...
        'private_incident_follow_up_created_v1': WebhookPrivateResourceV2FromJSON(json['private_incident.follow_up_created_v1']),
    };
}

export function PrivateIncidentFollowUpCreatedV1ResponseBodyToJSON(value?: PrivateIncidentFollowUpCreatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
