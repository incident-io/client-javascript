...
/**
 * Check if a given object implements the UpdateRequestBody3 interface.
 */
export function instanceOfUpdateRequestBody3(value: object): boolean {
    let isInstance = true;
...
export function UpdateRequestBody3FromJSON(json: any): UpdateRequestBody3 {
    return UpdateRequestBody3FromJSONTyped(json, false);
}

export function UpdateRequestBody3FromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateRequestBody3 {
...
export function UpdateRequestBody3ToJSON(value?: UpdateRequestBody3 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
