...
export interface ExternalResourceV1 {
     ...
     * @memberof ExternalResourceV1
     */
    resource_type: ExternalResourceV1ResourceTypeEnum;
    /**
     * Title of resource
     * @type {string}
     * @memberof ExternalResourceV1
 ...
 * @export
 */
export const ExternalResourceV1ResourceTypeEnum = {
...
export type ExternalResourceV1ResourceTypeEnum = typeof ExternalResourceV1ResourceTypeEnum[keyof typeof ExternalResourceV1ResourceTypeEnum];


/**
 * Check if a given object implements the ExternalResourceV1 interface.
 */
export function instanceOfExternalResourceV1(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "external_id" in value;
    isInstance = isInstance && "permalink" in value;
...
export function ExternalResourceV1FromJSON(json: any): ExternalResourceV1 {
    return ExternalResourceV1FromJSONTyped(json, false);
}

export function ExternalResourceV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalResourceV1 {
...
export function ExternalResourceV1ToJSON(value?: ExternalResourceV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
