...
import type { IdentityV1 } from './IdentityV1';
import {
    IdentityV1FromJSON,
    IdentityV1FromJSONTyped,
    IdentityV1ToJSON,
} from './IdentityV1';
...
export interface IdentityResponseBody {
     ...
     * 
     * @type {IdentityV1}
     * @memberof IdentityResponseBody
     */
    identity: IdentityV1;
}

/**
 * Check if a given object implements the IdentityResponseBody interface.
 */
export function instanceOfIdentityResponseBody(value: object): boolean {
    let isInstance = true;
...
export function IdentityResponseBodyFromJSON(json: any): IdentityResponseBody {
    return IdentityResponseBodyFromJSONTyped(json, false);
}

export function IdentityResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentityResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'identity': IdentityV1FromJSON(json['identity']),
    };
}

export function IdentityResponseBodyToJSON(value?: IdentityResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'identity': IdentityV1ToJSON(value.identity),
    };
}
