 ...
 * 
 * @export
 * @interface ListResponseBody7
 */
export interface ListResponseBody7 {
    /**
     * 
     * @type {Array<IncidentTimestampV2>}
     * @memberof ListResponseBody7
     */
    incident_timestamps: Array<IncidentTimestampV2>;
}

/**
 * Check if a given object implements the ListResponseBody7 interface.
 */
export function instanceOfListResponseBody7(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_timestamps" in value;

    return isInstance;
}

export function ListResponseBody7FromJSON(json: any): ListResponseBody7 {
    return ListResponseBody7FromJSONTyped(json, false);
}

export function ListResponseBody7FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody7 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_timestamps': ((json['incident_timestamps'] as Array<any>).map(IncidentTimestampV2FromJSON)),
    };
}

export function ListResponseBody7ToJSON(value?: ListResponseBody7 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_timestamps': ((value.incident_timestamps as Array<any>).map(IncidentTimestampV2ToJSON)),
    };
}
