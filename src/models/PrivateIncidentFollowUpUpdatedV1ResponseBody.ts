 ...
 * 
 * @export
 * @interface PrivateIncidentFollowUpUpdatedV1ResponseBody
 */
export interface PrivateIncidentFollowUpUpdatedV1ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PrivateIncidentFollowUpUpdatedV1ResponseBody
     */
    event_type: PrivateIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const PrivateIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum = {
...
export type PrivateIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum = typeof PrivateIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum[keyof typeof PrivateIncidentFollowUpUpdatedV1ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PrivateIncidentFollowUpUpdatedV1ResponseBody interface.
 */
export function instanceOfPrivateIncidentFollowUpUpdatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "private_incident_follow_up_updated_v1" in value;

    return isInstance;
}

export function PrivateIncidentFollowUpUpdatedV1ResponseBodyFromJSON(json: any): PrivateIncidentFollowUpUpdatedV1ResponseBody {
    return PrivateIncidentFollowUpUpdatedV1ResponseBodyFromJSONTyped(json, false);
}

export function PrivateIncidentFollowUpUpdatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivateIncidentFollowUpUpdatedV1ResponseBody {
    ...
    return {
        ...
        'private_incident_follow_up_updated_v1': WebhookPrivateResourceV2FromJSON(json['private_incident.follow_up_updated_v1']),
    };
}

export function PrivateIncidentFollowUpUpdatedV1ResponseBodyToJSON(value?: PrivateIncidentFollowUpUpdatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
