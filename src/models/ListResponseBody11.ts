 ...
 * 
 * @export
 * @interface ListResponseBody11
 */
export interface ListResponseBody11 {
    /**
     * 
     * @type {Array<IncidentV2>}
     * @memberof ListResponseBody11
     */
...
/**
 * Check if a given object implements the ListResponseBody11 interface.
 */
export function instanceOfListResponseBody11(value: object): boolean {
    let isInstance = true;
...
export function ListResponseBody11FromJSON(json: any): ListResponseBody11 {
    return ListResponseBody11FromJSONTyped(json, false);
}

export function ListResponseBody11FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody11 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incidents': ((json['incidents'] as Array<any>).map(IncidentV2FromJSON)),
        'pagination_meta': !exists(json, 'pagination_meta') ? undefined : PaginationMetaResultWithTotalFromJSON(json['pagination_meta']),
    };
}

export function ListResponseBody11ToJSON(value?: ListResponseBody11 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incidents': ((value.incidents as Array<any>).map(IncidentV2ToJSON)),
