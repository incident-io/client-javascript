...
/**
 * Check if a given object implements the CustomFieldValuePayloadV1 interface.
 */
export function instanceOfCustomFieldValuePayloadV1(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CustomFieldValuePayloadV1FromJSON(json: any): CustomFieldValuePayloadV1 {
    return CustomFieldValuePayloadV1FromJSONTyped(json, false);
}

export function CustomFieldValuePayloadV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldValuePayloadV1 {
    ...
    return {
        ...
        'value_timestamp': !exists(json, 'value_timestamp') ? undefined : json['value_timestamp'],
    };
}

export function CustomFieldValuePayloadV1ToJSON(value?: CustomFieldValuePayloadV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
