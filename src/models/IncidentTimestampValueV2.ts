 ...
 * 
 * @export
 * @interface IncidentTimestampValueV2
 */
export interface IncidentTimestampValueV2 {
    /**
     * The current value of this timestamp, for this incident
     * @type {Date}
     * @memberof IncidentTimestampValueV2
     */
    value?: Date;
}

/**
 * Check if a given object implements the IncidentTimestampValueV2 interface.
 */
export function instanceOfIncidentTimestampValueV2(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IncidentTimestampValueV2FromJSON(json: any): IncidentTimestampValueV2 {
    return IncidentTimestampValueV2FromJSONTyped(json, false);
}

export function IncidentTimestampValueV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentTimestampValueV2 {
...
export function IncidentTimestampValueV2ToJSON(value?: IncidentTimestampValueV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
