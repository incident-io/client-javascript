 ...
 * 
 * @export
 * @interface AuditLogTargetV2
 */
export interface AuditLogTargetV2 {
    /**
     * The ID of the target
     * @type {string}
     * @memberof AuditLogTargetV2
     */
    id: string;
    /**
 ...
 * @export
 */
export const AuditLogTargetV2TypeEnum = {
...
export type AuditLogTargetV2TypeEnum = typeof AuditLogTargetV2TypeEnum[keyof typeof AuditLogTargetV2TypeEnum];


/**
 * Check if a given object implements the AuditLogTargetV2 interface.
 */
export function instanceOfAuditLogTargetV2(value: object): boolean {
    let isInstance = true;
...
export function AuditLogTargetV2FromJSON(json: any): AuditLogTargetV2 {
    return AuditLogTargetV2FromJSONTyped(json, false);
}

export function AuditLogTargetV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditLogTargetV2 {
...
export function AuditLogTargetV2ToJSON(value?: AuditLogTargetV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
