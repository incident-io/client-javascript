 ...
 * 
 * @export
 * @interface WebhookPrivateResourceV2
 */
export interface WebhookPrivateResourceV2 {
    /**
     * The ID of the resource
     * @type {string}
     * @memberof WebhookPrivateResourceV2
     */
    id: string;
}

/**
 * Check if a given object implements the WebhookPrivateResourceV2 interface.
 */
export function instanceOfWebhookPrivateResourceV2(value: object): boolean {
    let isInstance = true;
...
export function WebhookPrivateResourceV2FromJSON(json: any): WebhookPrivateResourceV2 {
    return WebhookPrivateResourceV2FromJSONTyped(json, false);
}

export function WebhookPrivateResourceV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookPrivateResourceV2 {
...
export function WebhookPrivateResourceV2ToJSON(value?: WebhookPrivateResourceV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
