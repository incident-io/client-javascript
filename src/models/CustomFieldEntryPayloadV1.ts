...
import type { CustomFieldValuePayloadV1 } from './CustomFieldValuePayloadV1';
import {
    CustomFieldValuePayloadV1FromJSON,
    CustomFieldValuePayloadV1FromJSONTyped,
    CustomFieldValuePayloadV1ToJSON,
} from './CustomFieldValuePayloadV1';

/**
 * 
 * @export
 * @interface CustomFieldEntryPayloadV1
 */
export interface CustomFieldEntryPayloadV1 {
    /**
     * ID of the custom field this entry is linked against
     * @type {string}
     * @memberof CustomFieldEntryPayloadV1
     */
    custom_field_id: string;
    /**
     * List of values to associate with this entry
     * @type {Array<CustomFieldValuePayloadV1>}
     * @memberof CustomFieldEntryPayloadV1
     */
...
/**
 * Check if a given object implements the CustomFieldEntryPayloadV1 interface.
 */
export function instanceOfCustomFieldEntryPayloadV1(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "custom_field_id" in value;
    isInstance = isInstance && "values" in value;

    return isInstance;
}

export function CustomFieldEntryPayloadV1FromJSON(json: any): CustomFieldEntryPayloadV1 {
    return CustomFieldEntryPayloadV1FromJSONTyped(json, false);
}

export function CustomFieldEntryPayloadV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldEntryPayloadV1 {
    ...
    return {
        ...
        'values': ((json['values'] as Array<any>).map(CustomFieldValuePayloadV1FromJSON)),
    };
}

export function CustomFieldEntryPayloadV1ToJSON(value?: CustomFieldEntryPayloadV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'values': ((value.values as Array<any>).map(CustomFieldValuePayloadV1ToJSON)),
    };
}
