 ...
 * 
 * @export
 * @interface ShowResponseBody10
 */
export interface ShowResponseBody10 {
    /**
     * 
     * @type {SeverityV2}
     * @memberof ShowResponseBody10
     */
    severity: SeverityV2;
}

/**
 * Check if a given object implements the ShowResponseBody10 interface.
 */
export function instanceOfShowResponseBody10(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody10FromJSON(json: any): ShowResponseBody10 {
    return ShowResponseBody10FromJSONTyped(json, false);
}

export function ShowResponseBody10FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody10 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'severity': SeverityV2FromJSON(json['severity']),
    };
}

export function ShowResponseBody10ToJSON(value?: ShowResponseBody10 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
