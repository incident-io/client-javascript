 ...
 * 
 * @export
 * @interface CreateRequestBody8
 */
export interface CreateRequestBody8 {
    /**
     * Description of the severity
     * @type {string}
     * @memberof CreateRequestBody8
     */
    description: string;
    /**
...
/**
 * Check if a given object implements the CreateRequestBody8 interface.
 */
export function instanceOfCreateRequestBody8(value: object): boolean {
    let isInstance = true;
...
export function CreateRequestBody8FromJSON(json: any): CreateRequestBody8 {
    return CreateRequestBody8FromJSONTyped(json, false);
}

export function CreateRequestBody8FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRequestBody8 {
...
export function CreateRequestBody8ToJSON(value?: CreateRequestBody8 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
