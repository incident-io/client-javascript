...
/**
 * Check if a given object implements the CustomFieldOptionV1 interface.
 */
export function instanceOfCustomFieldOptionV1(value: object): boolean {
    let isInstance = true;
...
export function CustomFieldOptionV1FromJSON(json: any): CustomFieldOptionV1 {
    return CustomFieldOptionV1FromJSONTyped(json, false);
}

export function CustomFieldOptionV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldOptionV1 {
...
export function CustomFieldOptionV1ToJSON(value?: CustomFieldOptionV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
