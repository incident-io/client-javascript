...
import type { IncidentTimestampV2 } from './IncidentTimestampV2';
import {
    IncidentTimestampV2FromJSON,
    IncidentTimestampV2FromJSONTyped,
    IncidentTimestampV2ToJSON,
} from './IncidentTimestampV2';
import type { IncidentTimestampValueV2 } from './IncidentTimestampValueV2';
import {
    IncidentTimestampValueV2FromJSON,
    IncidentTimestampValueV2FromJSONTyped,
    IncidentTimestampValueV2ToJSON,
} from './IncidentTimestampValueV2';

/**
 * 
 * @export
 * @interface IncidentTimestampWithValueV2
 */
export interface IncidentTimestampWithValueV2 {
    /**
     * 
     * @type {IncidentTimestampV2}
     * @memberof IncidentTimestampWithValueV2
     */
...
/**
 * Check if a given object implements the IncidentTimestampWithValueV2 interface.
 */
export function instanceOfIncidentTimestampWithValueV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_timestamp" in value;

    return isInstance;
}

export function IncidentTimestampWithValueV2FromJSON(json: any): IncidentTimestampWithValueV2 {
    return IncidentTimestampWithValueV2FromJSONTyped(json, false);
}

export function IncidentTimestampWithValueV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentTimestampWithValueV2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_timestamp': IncidentTimestampV2FromJSON(json['incident_timestamp']),
        'value': !exists(json, 'value') ? undefined : IncidentTimestampValueV2FromJSON(json['value']),
    };
}

export function IncidentTimestampWithValueV2ToJSON(value?: IncidentTimestampWithValueV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_timestamp': IncidentTimestampV2ToJSON(value.incident_timestamp),
        'value': IncidentTimestampValueV2ToJSON(value.value),
    };
}
