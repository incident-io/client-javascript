 ...
 * 
 * @export
 * @interface CreateTypeResponseBody
 */
export interface CreateTypeResponseBody {
    /**
     * 
     * @type {CatalogTypeV2}
     * @memberof CreateTypeResponseBody
     */
    catalog_type: CatalogTypeV2;
}

/**
 * Check if a given object implements the CreateTypeResponseBody interface.
 */
export function instanceOfCreateTypeResponseBody(value: object): boolean {
    let isInstance = true;
...
export function CreateTypeResponseBodyFromJSON(json: any): CreateTypeResponseBody {
    return CreateTypeResponseBodyFromJSONTyped(json, false);
}

export function CreateTypeResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateTypeResponseBody {
...
export function CreateTypeResponseBodyToJSON(value?: CreateTypeResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
