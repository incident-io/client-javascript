 ...
 * 
 * @export
 * @interface ListResponseBody8
 */
export interface ListResponseBody8 {
    /**
     * 
     * @type {Array<IncidentTypeV1>}
     * @memberof ListResponseBody8
     */
    incident_types: Array<IncidentTypeV1>;
}

/**
 * Check if a given object implements the ListResponseBody8 interface.
 */
export function instanceOfListResponseBody8(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_types" in value;

    return isInstance;
}

export function ListResponseBody8FromJSON(json: any): ListResponseBody8 {
    return ListResponseBody8FromJSONTyped(json, false);
}

export function ListResponseBody8FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody8 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_types': ((json['incident_types'] as Array<any>).map(IncidentTypeV1FromJSON)),
    };
}

export function ListResponseBody8ToJSON(value?: ListResponseBody8 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_types': ((value.incident_types as Array<any>).map(IncidentTypeV1ToJSON)),
    };
}
