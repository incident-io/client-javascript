...
import type { CreateRequestBody3Resource } from './CreateRequestBody3Resource';
import {
    CreateRequestBody3ResourceFromJSON,
    CreateRequestBody3ResourceFromJSONTyped,
    CreateRequestBody3ResourceToJSON,
} from './CreateRequestBody3Resource';

/**
 * 
 * @export
 * @interface CreateRequestBody3
 */
export interface CreateRequestBody3 {
    /**
     * ID of the incident to add an attachment to
     * @type {string}
     * @memberof CreateRequestBody3
     */
    incident_id: string;
    /**
     * 
     * @type {CreateRequestBody3Resource}
     * @memberof CreateRequestBody3
     */
    resource: CreateRequestBody3Resource;
}

/**
 * Check if a given object implements the CreateRequestBody3 interface.
 */
export function instanceOfCreateRequestBody3(value: object): boolean {
    let isInstance = true;
...
export function CreateRequestBody3FromJSON(json: any): CreateRequestBody3 {
    return CreateRequestBody3FromJSONTyped(json, false);
}

export function CreateRequestBody3FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRequestBody3 {
    ...
    return {
        ...
        'resource': CreateRequestBody3ResourceFromJSON(json['resource']),
    };
}

export function CreateRequestBody3ToJSON(value?: CreateRequestBody3 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'resource': CreateRequestBody3ResourceToJSON(value.resource),
    };
}
