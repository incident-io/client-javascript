...
import type { CustomFieldTypeInfoV1 } from './CustomFieldTypeInfoV1';
import {
    CustomFieldTypeInfoV1FromJSON,
    CustomFieldTypeInfoV1FromJSONTyped,
    CustomFieldTypeInfoV1ToJSON,
} from './CustomFieldTypeInfoV1';
import type { CustomFieldValueV1 } from './CustomFieldValueV1';
import {
    CustomFieldValueV1FromJSON,
    CustomFieldValueV1FromJSONTyped,
    CustomFieldValueV1ToJSON,
} from './CustomFieldValueV1';

/**
 * 
 * @export
 * @interface CustomFieldEntryV1
 */
export interface CustomFieldEntryV1 {
    /**
     * 
     * @type {CustomFieldTypeInfoV1}
     * @memberof CustomFieldEntryV1
     */
    custom_field: CustomFieldTypeInfoV1;
    /**
     * List of custom field values set on this entry
     * @type {Array<CustomFieldValueV1>}
     * @memberof CustomFieldEntryV1
     */
...
/**
 * Check if a given object implements the CustomFieldEntryV1 interface.
 */
export function instanceOfCustomFieldEntryV1(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "custom_field" in value;
    isInstance = isInstance && "values" in value;

    return isInstance;
}

export function CustomFieldEntryV1FromJSON(json: any): CustomFieldEntryV1 {
    return CustomFieldEntryV1FromJSONTyped(json, false);
}

export function CustomFieldEntryV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldEntryV1 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'custom_field': CustomFieldTypeInfoV1FromJSON(json['custom_field']),
        'values': ((json['values'] as Array<any>).map(CustomFieldValueV1FromJSON)),
    };
}

export function CustomFieldEntryV1ToJSON(value?: CustomFieldEntryV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'custom_field': CustomFieldTypeInfoV1ToJSON(value.custom_field),
        'values': ((value.values as Array<any>).map(CustomFieldValueV1ToJSON)),
    };
}
