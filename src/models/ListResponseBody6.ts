 ...
 * 
 * @export
 * @interface ListResponseBody6
 */
export interface ListResponseBody6 {
    /**
     * 
     * @type {Array<IncidentStatusV1>}
     * @memberof ListResponseBody6
     */
    incident_statuses: Array<IncidentStatusV1>;
}

/**
 * Check if a given object implements the ListResponseBody6 interface.
 */
export function instanceOfListResponseBody6(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_statuses" in value;

    return isInstance;
}

export function ListResponseBody6FromJSON(json: any): ListResponseBody6 {
    return ListResponseBody6FromJSONTyped(json, false);
}

export function ListResponseBody6FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody6 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_statuses': ((json['incident_statuses'] as Array<any>).map(IncidentStatusV1FromJSON)),
    };
}

export function ListResponseBody6ToJSON(value?: ListResponseBody6 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_statuses': ((value.incident_statuses as Array<any>).map(IncidentStatusV1ToJSON)),
    };
}
