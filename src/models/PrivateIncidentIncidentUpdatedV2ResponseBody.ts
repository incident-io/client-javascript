 ...
 * 
 * @export
 * @interface PrivateIncidentIncidentUpdatedV2ResponseBody
 */
export interface PrivateIncidentIncidentUpdatedV2ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PrivateIncidentIncidentUpdatedV2ResponseBody
     */
    event_type: PrivateIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const PrivateIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum = {
...
export type PrivateIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum = typeof PrivateIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum[keyof typeof PrivateIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PrivateIncidentIncidentUpdatedV2ResponseBody interface.
 */
export function instanceOfPrivateIncidentIncidentUpdatedV2ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "private_incident_incident_updated_v2" in value;

    return isInstance;
}

export function PrivateIncidentIncidentUpdatedV2ResponseBodyFromJSON(json: any): PrivateIncidentIncidentUpdatedV2ResponseBody {
    return PrivateIncidentIncidentUpdatedV2ResponseBodyFromJSONTyped(json, false);
}

export function PrivateIncidentIncidentUpdatedV2ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivateIncidentIncidentUpdatedV2ResponseBody {
    ...
    return {
        ...
        'private_incident_incident_updated_v2': WebhookPrivateResourceV2FromJSON(json['private_incident.incident_updated_v2']),
    };
}

export function PrivateIncidentIncidentUpdatedV2ResponseBodyToJSON(value?: PrivateIncidentIncidentUpdatedV2ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
