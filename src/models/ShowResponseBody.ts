 ...
 * 
 * @export
 * @interface ShowResponseBody
 */
export interface ShowResponseBody {
    /**
     * 
     * @type {ActionV1}
     * @memberof ShowResponseBody
     */
    action: ActionV1;
}

/**
 * Check if a given object implements the ShowResponseBody interface.
 */
export function instanceOfShowResponseBody(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBodyFromJSON(json: any): ShowResponseBody {
    return ShowResponseBodyFromJSONTyped(json, false);
}

export function ShowResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'action': ActionV1FromJSON(json['action']),
    };
}

export function ShowResponseBodyToJSON(value?: ShowResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'action': ActionV1ToJSON(value.action),
    };
}
