...
/**
 * Check if a given object implements the PaginationMetaResult interface.
 */
export function instanceOfPaginationMetaResult(value: object): boolean {
    let isInstance = true;
...
export function PaginationMetaResultFromJSON(json: any): PaginationMetaResult {
    return PaginationMetaResultFromJSONTyped(json, false);
}

export function PaginationMetaResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginationMetaResult {
...
export function PaginationMetaResultToJSON(value?: PaginationMetaResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
