...
import type { CatalogAttributeBindingPayloadV2 } from './CatalogAttributeBindingPayloadV2';
import {
    CatalogAttributeBindingPayloadV2FromJSON,
    CatalogAttributeBindingPayloadV2FromJSONTyped,
    CatalogAttributeBindingPayloadV2ToJSON,
} from './CatalogAttributeBindingPayloadV2';
...
export interface CreateEntryRequestBody {
     ...
     * @type {Array<string>}
     * @memberof CreateEntryRequestBody
     */
    aliases?: Array<string>;
    /**
     * Values of this entry
     * @type {{ [key: string]: CatalogAttributeBindingPayloadV2; }}
     * @memberof CreateEntryRequestBody
     */
    attribute_values: { [key: string]: CatalogAttributeBindingPayloadV2; };
    /**
...
/**
 * Check if a given object implements the CreateEntryRequestBody interface.
 */
export function instanceOfCreateEntryRequestBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "attribute_values" in value;
    isInstance = isInstance && "catalog_type_id" in value;
    isInstance = isInstance && "name" in value;

    return isInstance;
}

export function CreateEntryRequestBodyFromJSON(json: any): CreateEntryRequestBody {
    return CreateEntryRequestBodyFromJSONTyped(json, false);
}

export function CreateEntryRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateEntryRequestBody {
    ...
    return {
        ...
        'attribute_values': (mapValues(json['attribute_values'], CatalogAttributeBindingPayloadV2FromJSON)),
...
export function CreateEntryRequestBodyToJSON(value?: CreateEntryRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'attribute_values': (mapValues(value.attribute_values, CatalogAttributeBindingPayloadV2ToJSON)),
