...
import type { IncidentV1 } from './IncidentV1';
import {
    IncidentV1FromJSON,
    IncidentV1FromJSONTyped,
    IncidentV1ToJSON,
} from './IncidentV1';
import type { PaginationMetaResultWithTotal } from './PaginationMetaResultWithTotal';
import {
    PaginationMetaResultWithTotalFromJSON,
    PaginationMetaResultWithTotalFromJSONTyped,
    PaginationMetaResultWithTotalToJSON,
} from './PaginationMetaResultWithTotal';

/**
 * 
 * @export
 * @interface ListResponseBody10
 */
export interface ListResponseBody10 {
    /**
     * 
     * @type {Array<IncidentV1>}
     * @memberof ListResponseBody10
     */
...
/**
 * Check if a given object implements the ListResponseBody10 interface.
 */
export function instanceOfListResponseBody10(value: object): boolean {
    let isInstance = true;
...
export function ListResponseBody10FromJSON(json: any): ListResponseBody10 {
    return ListResponseBody10FromJSONTyped(json, false);
}

export function ListResponseBody10FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody10 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incidents': ((json['incidents'] as Array<any>).map(IncidentV1FromJSON)),
        'pagination_meta': !exists(json, 'pagination_meta') ? undefined : PaginationMetaResultWithTotalFromJSON(json['pagination_meta']),
    };
}

export function ListResponseBody10ToJSON(value?: ListResponseBody10 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incidents': ((value.incidents as Array<any>).map(IncidentV1ToJSON)),
        'pagination_meta': PaginationMetaResultWithTotalToJSON(value.pagination_meta),
    };
}
