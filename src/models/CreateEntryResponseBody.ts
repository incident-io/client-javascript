 ...
 * 
 * @export
 * @interface CreateEntryResponseBody
 */
export interface CreateEntryResponseBody {
    /**
     * 
     * @type {CatalogEntryV2}
     * @memberof CreateEntryResponseBody
     */
    catalog_entry: CatalogEntryV2;
}

/**
 * Check if a given object implements the CreateEntryResponseBody interface.
 */
export function instanceOfCreateEntryResponseBody(value: object): boolean {
    let isInstance = true;
...
export function CreateEntryResponseBodyFromJSON(json: any): CreateEntryResponseBody {
    return CreateEntryResponseBodyFromJSONTyped(json, false);
}

export function CreateEntryResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateEntryResponseBody {
...
export function CreateEntryResponseBodyToJSON(value?: CreateEntryResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
