 ...
 * 
 * @export
 * @interface CatalogEntryReferenceV2
 */
export interface CatalogEntryReferenceV2 {
    /**
     * ID of this catalog entry
     * @type {string}
     * @memberof CatalogEntryReferenceV2
     */
...
/**
 * Check if a given object implements the CatalogEntryReferenceV2 interface.
 */
export function instanceOfCatalogEntryReferenceV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "catalog_entry_id" in value;
    isInstance = isInstance && "catalog_entry_name" in value;
    isInstance = isInstance && "catalog_type_id" in value;

    return isInstance;
}

export function CatalogEntryReferenceV2FromJSON(json: any): CatalogEntryReferenceV2 {
    return CatalogEntryReferenceV2FromJSONTyped(json, false);
}

export function CatalogEntryReferenceV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogEntryReferenceV2 {
...
export function CatalogEntryReferenceV2ToJSON(value?: CatalogEntryReferenceV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
