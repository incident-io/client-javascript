 ...
 * 
 * @export
 * @interface CreateRequestBody4
 */
export interface CreateRequestBody4 {
    /**
     * Describes the purpose of the role
     * @type {string}
     * @memberof CreateRequestBody4
     */
    description: string;
    /**
...
/**
 * Check if a given object implements the CreateRequestBody4 interface.
 */
export function instanceOfCreateRequestBody4(value: object): boolean {
    let isInstance = true;
...
export function CreateRequestBody4FromJSON(json: any): CreateRequestBody4 {
    return CreateRequestBody4FromJSONTyped(json, false);
}

export function CreateRequestBody4FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRequestBody4 {
...
export function CreateRequestBody4ToJSON(value?: CreateRequestBody4 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
