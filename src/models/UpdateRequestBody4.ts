...
/**
 * Check if a given object implements the UpdateRequestBody4 interface.
 */
export function instanceOfUpdateRequestBody4(value: object): boolean {
    let isInstance = true;
...
export function UpdateRequestBody4FromJSON(json: any): UpdateRequestBody4 {
    return UpdateRequestBody4FromJSONTyped(json, false);
}

export function UpdateRequestBody4FromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateRequestBody4 {
...
export function UpdateRequestBody4ToJSON(value?: UpdateRequestBody4 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
