 ...
 * 
 * @export
 * @interface PublicIncidentIncidentUpdatedV2ResponseBody
 */
export interface PublicIncidentIncidentUpdatedV2ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PublicIncidentIncidentUpdatedV2ResponseBody
     */
    event_type: PublicIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum;
    /**
     * 
     * @type {IncidentV2}
     * @memberof PublicIncidentIncidentUpdatedV2ResponseBody
 ...
 * @export
 */
export const PublicIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum = {
...
export type PublicIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum = typeof PublicIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum[keyof typeof PublicIncidentIncidentUpdatedV2ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PublicIncidentIncidentUpdatedV2ResponseBody interface.
 */
export function instanceOfPublicIncidentIncidentUpdatedV2ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "public_incident_incident_updated_v2" in value;

    return isInstance;
}

export function PublicIncidentIncidentUpdatedV2ResponseBodyFromJSON(json: any): PublicIncidentIncidentUpdatedV2ResponseBody {
    return PublicIncidentIncidentUpdatedV2ResponseBodyFromJSONTyped(json, false);
}

export function PublicIncidentIncidentUpdatedV2ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicIncidentIncidentUpdatedV2ResponseBody {
    ...
    return {
        ...
        'public_incident_incident_updated_v2': IncidentV2FromJSON(json['public_incident.incident_updated_v2']),
    };
}

export function PublicIncidentIncidentUpdatedV2ResponseBodyToJSON(value?: PublicIncidentIncidentUpdatedV2ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
