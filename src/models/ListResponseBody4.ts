...
import type { IncidentAttachmentV1 } from './IncidentAttachmentV1';
import {
    IncidentAttachmentV1FromJSON,
    IncidentAttachmentV1FromJSONTyped,
    IncidentAttachmentV1ToJSON,
} from './IncidentAttachmentV1';

/**
 * 
 * @export
 * @interface ListResponseBody4
 */
export interface ListResponseBody4 {
    /**
     * 
     * @type {Array<IncidentAttachmentV1>}
     * @memberof ListResponseBody4
     */
    incident_attachments: Array<IncidentAttachmentV1>;
}

/**
 * Check if a given object implements the ListResponseBody4 interface.
 */
export function instanceOfListResponseBody4(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_attachments" in value;

    return isInstance;
}

export function ListResponseBody4FromJSON(json: any): ListResponseBody4 {
    return ListResponseBody4FromJSONTyped(json, false);
}

export function ListResponseBody4FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListResponseBody4 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'incident_attachments': ((json['incident_attachments'] as Array<any>).map(IncidentAttachmentV1FromJSON)),
    };
}

export function ListResponseBody4ToJSON(value?: ListResponseBody4 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incident_attachments': ((value.incident_attachments as Array<any>).map(IncidentAttachmentV1ToJSON)),
    };
}
