 ...
 * 
 * @export
 * @interface IncidentTypeV1
 */
export interface IncidentTypeV1 {
    /**
     * Whether incidents of this must always, or can optionally, be created in triage
     * @type {string}
     * @memberof IncidentTypeV1
     */
    create_in_triage: IncidentTypeV1CreateInTriageEnum;
    /**
 ...
 * @export
 */
export const IncidentTypeV1CreateInTriageEnum = {
    Always: 'always',
    Optional: 'optional'
} as const;
export type IncidentTypeV1CreateInTriageEnum = typeof IncidentTypeV1CreateInTriageEnum[keyof typeof IncidentTypeV1CreateInTriageEnum];


/**
 * Check if a given object implements the IncidentTypeV1 interface.
 */
export function instanceOfIncidentTypeV1(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "create_in_triage" in value;
    isInstance = isInstance && "created_at" in value;
    isInstance = isInstance && "description" in value;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "is_default" in value;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "private_incidents_only" in value;
    isInstance = isInstance && "updated_at" in value;

    return isInstance;
}

export function IncidentTypeV1FromJSON(json: any): IncidentTypeV1 {
    return IncidentTypeV1FromJSONTyped(json, false);
}

export function IncidentTypeV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentTypeV1 {
...
export function IncidentTypeV1ToJSON(value?: IncidentTypeV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
