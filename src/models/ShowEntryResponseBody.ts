 ...
 * 
 * @export
 * @interface ShowEntryResponseBody
 */
export interface ShowEntryResponseBody {
    /**
     * 
     * @type {CatalogEntryV2}
     * @memberof ShowEntryResponseBody
     */
...
/**
 * Check if a given object implements the ShowEntryResponseBody interface.
 */
export function instanceOfShowEntryResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "catalog_entry" in value;
    isInstance = isInstance && "catalog_type" in value;

    return isInstance;
}

export function ShowEntryResponseBodyFromJSON(json: any): ShowEntryResponseBody {
    return ShowEntryResponseBodyFromJSONTyped(json, false);
}

export function ShowEntryResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowEntryResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'catalog_entry': CatalogEntryV2FromJSON(json['catalog_entry']),
        'catalog_type': CatalogTypeV2FromJSON(json['catalog_type']),
    };
}

export function ShowEntryResponseBodyToJSON(value?: ShowEntryResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'catalog_entry': CatalogEntryV2ToJSON(value.catalog_entry),
