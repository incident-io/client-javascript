...
import type { ExternalResourceV1 } from './ExternalResourceV1';
import {
    ExternalResourceV1FromJSON,
    ExternalResourceV1FromJSONTyped,
    ExternalResourceV1ToJSON,
} from './ExternalResourceV1';

/**
 * 
 * @export
 * @interface IncidentAttachmentV1
 */
export interface IncidentAttachmentV1 {
    /**
     * Unique identifier of this incident membership
     * @type {string}
     * @memberof IncidentAttachmentV1
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the IncidentAttachmentV1 interface.
 */
export function instanceOfIncidentAttachmentV1(value: object): boolean {
    let isInstance = true;
...
export function IncidentAttachmentV1FromJSON(json: any): IncidentAttachmentV1 {
    return IncidentAttachmentV1FromJSONTyped(json, false);
}

export function IncidentAttachmentV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentAttachmentV1 {
    ...
    return {
        ...
        'resource': ExternalResourceV1FromJSON(json['resource']),
    };
}

export function IncidentAttachmentV1ToJSON(value?: IncidentAttachmentV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'resource': ExternalResourceV1ToJSON(value.resource),
    };
}
