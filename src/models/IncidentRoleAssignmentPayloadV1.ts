 ...
 * 
 * @export
 * @interface IncidentRoleAssignmentPayloadV1
 */
export interface IncidentRoleAssignmentPayloadV1 {
    /**
     * 
     * @type {UserReferencePayloadV1}
     * @memberof IncidentRoleAssignmentPayloadV1
     */
...
/**
 * Check if a given object implements the IncidentRoleAssignmentPayloadV1 interface.
 */
export function instanceOfIncidentRoleAssignmentPayloadV1(value: object): boolean {
    let isInstance = true;
...
export function IncidentRoleAssignmentPayloadV1FromJSON(json: any): IncidentRoleAssignmentPayloadV1 {
    return IncidentRoleAssignmentPayloadV1FromJSONTyped(json, false);
}

export function IncidentRoleAssignmentPayloadV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentRoleAssignmentPayloadV1 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'assignee': UserReferencePayloadV1FromJSON(json['assignee']),
        'incident_role_id': json['incident_role_id'],
    };
}

export function IncidentRoleAssignmentPayloadV1ToJSON(value?: IncidentRoleAssignmentPayloadV1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
