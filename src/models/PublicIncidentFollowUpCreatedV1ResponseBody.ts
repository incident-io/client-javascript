 ...
 * 
 * @export
 * @interface PublicIncidentFollowUpCreatedV1ResponseBody
 */
export interface PublicIncidentFollowUpCreatedV1ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PublicIncidentFollowUpCreatedV1ResponseBody
     */
    event_type: PublicIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum;
    /**
     * 
     * @type {ActionV1}
     * @memberof PublicIncidentFollowUpCreatedV1ResponseBody
 ...
 * @export
 */
export const PublicIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum = {
...
export type PublicIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum = typeof PublicIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum[keyof typeof PublicIncidentFollowUpCreatedV1ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PublicIncidentFollowUpCreatedV1ResponseBody interface.
 */
export function instanceOfPublicIncidentFollowUpCreatedV1ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "public_incident_follow_up_created_v1" in value;

    return isInstance;
}

export function PublicIncidentFollowUpCreatedV1ResponseBodyFromJSON(json: any): PublicIncidentFollowUpCreatedV1ResponseBody {
    return PublicIncidentFollowUpCreatedV1ResponseBodyFromJSONTyped(json, false);
}

export function PublicIncidentFollowUpCreatedV1ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicIncidentFollowUpCreatedV1ResponseBody {
    ...
    return {
        ...
        'public_incident_follow_up_created_v1': ActionV1FromJSON(json['public_incident.follow_up_created_v1']),
    };
}

export function PublicIncidentFollowUpCreatedV1ResponseBodyToJSON(value?: PublicIncidentFollowUpCreatedV1ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
