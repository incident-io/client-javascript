...
/**
 * Check if a given object implements the AuditLogEntryContextV2 interface.
 */
export function instanceOfAuditLogEntryContextV2(value: object): boolean {
    let isInstance = true;
...
export function AuditLogEntryContextV2FromJSON(json: any): AuditLogEntryContextV2 {
    return AuditLogEntryContextV2FromJSONTyped(json, false);
}

export function AuditLogEntryContextV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditLogEntryContextV2 {
...
export function AuditLogEntryContextV2ToJSON(value?: AuditLogEntryContextV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
