 ...
 * 
 * @export
 * @interface ShowResponseBody6
 */
export interface ShowResponseBody6 {
    /**
     * 
     * @type {IncidentTimestampV2}
     * @memberof ShowResponseBody6
     */
    incident_timestamp: IncidentTimestampV2;
}

/**
 * Check if a given object implements the ShowResponseBody6 interface.
 */
export function instanceOfShowResponseBody6(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody6FromJSON(json: any): ShowResponseBody6 {
    return ShowResponseBody6FromJSONTyped(json, false);
}

export function ShowResponseBody6FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody6 {
...
export function ShowResponseBody6ToJSON(value?: ShowResponseBody6 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
