 ...
 * 
 * @export
 * @interface IncidentTimestampValuePayloadV2
 */
export interface IncidentTimestampValuePayloadV2 {
     ...
     * @type {string}
     * @memberof IncidentTimestampValuePayloadV2
     */
...
/**
 * Check if a given object implements the IncidentTimestampValuePayloadV2 interface.
 */
export function instanceOfIncidentTimestampValuePayloadV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "incident_timestamp_id" in value;

    return isInstance;
}

export function IncidentTimestampValuePayloadV2FromJSON(json: any): IncidentTimestampValuePayloadV2 {
    return IncidentTimestampValuePayloadV2FromJSONTyped(json, false);
}

export function IncidentTimestampValuePayloadV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): IncidentTimestampValuePayloadV2 {
...
export function IncidentTimestampValuePayloadV2ToJSON(value?: IncidentTimestampValuePayloadV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
