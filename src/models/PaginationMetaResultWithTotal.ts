...
/**
 * Check if a given object implements the PaginationMetaResultWithTotal interface.
 */
export function instanceOfPaginationMetaResultWithTotal(value: object): boolean {
    let isInstance = true;
...
export function PaginationMetaResultWithTotalFromJSON(json: any): PaginationMetaResultWithTotal {
    return PaginationMetaResultWithTotalFromJSONTyped(json, false);
}

export function PaginationMetaResultWithTotalFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginationMetaResultWithTotal {
...
export function PaginationMetaResultWithTotalToJSON(value?: PaginationMetaResultWithTotal | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
