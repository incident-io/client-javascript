 ...
 * 
 * @export
 * @interface PrivateIncidentIncidentCreatedV2ResponseBody
 */
export interface PrivateIncidentIncidentCreatedV2ResponseBody {
    /**
     * What type of event is this webhook for?
     * @type {string}
     * @memberof PrivateIncidentIncidentCreatedV2ResponseBody
     */
    event_type: PrivateIncidentIncidentCreatedV2ResponseBodyEventTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const PrivateIncidentIncidentCreatedV2ResponseBodyEventTypeEnum = {
...
export type PrivateIncidentIncidentCreatedV2ResponseBodyEventTypeEnum = typeof PrivateIncidentIncidentCreatedV2ResponseBodyEventTypeEnum[keyof typeof PrivateIncidentIncidentCreatedV2ResponseBodyEventTypeEnum];


/**
 * Check if a given object implements the PrivateIncidentIncidentCreatedV2ResponseBody interface.
 */
export function instanceOfPrivateIncidentIncidentCreatedV2ResponseBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "event_type" in value;
    isInstance = isInstance && "private_incident_incident_created_v2" in value;

    return isInstance;
}

export function PrivateIncidentIncidentCreatedV2ResponseBodyFromJSON(json: any): PrivateIncidentIncidentCreatedV2ResponseBody {
    return PrivateIncidentIncidentCreatedV2ResponseBodyFromJSONTyped(json, false);
}

export function PrivateIncidentIncidentCreatedV2ResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivateIncidentIncidentCreatedV2ResponseBody {
    ...
    return {
        ...
        'private_incident_incident_created_v2': WebhookPrivateResourceV2FromJSON(json['private_incident.incident_created_v2']),
    };
}

export function PrivateIncidentIncidentCreatedV2ResponseBodyToJSON(value?: PrivateIncidentIncidentCreatedV2ResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
