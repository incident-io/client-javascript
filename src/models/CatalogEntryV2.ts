...
import type { CatalogAttributeBindingV2 } from './CatalogAttributeBindingV2';
import {
    CatalogAttributeBindingV2FromJSON,
    CatalogAttributeBindingV2FromJSONTyped,
    CatalogAttributeBindingV2ToJSON,
} from './CatalogAttributeBindingV2';

/**
 * 
 * @export
 * @interface CatalogEntryV2
 */
export interface CatalogEntryV2 {
    /**
     * Optional aliases that can be used to reference this entry
     * @type {Array<string>}
     * @memberof CatalogEntryV2
     */
    aliases: Array<string>;
    /**
     * Values of this entry
     * @type {{ [key: string]: CatalogAttributeBindingV2; }}
     * @memberof CatalogEntryV2
     */
    attribute_values: { [key: string]: CatalogAttributeBindingV2; };
    /**
...
/**
 * Check if a given object implements the CatalogEntryV2 interface.
 */
export function instanceOfCatalogEntryV2(value: object): boolean {
    let isInstance = true;
...
export function CatalogEntryV2FromJSON(json: any): CatalogEntryV2 {
    return CatalogEntryV2FromJSONTyped(json, false);
}

export function CatalogEntryV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogEntryV2 {
    ...
    return {
        ...
        'attribute_values': (mapValues(json['attribute_values'], CatalogAttributeBindingV2FromJSON)),
...
export function CatalogEntryV2ToJSON(value?: CatalogEntryV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'attribute_values': (mapValues(value.attribute_values, CatalogAttributeBindingV2ToJSON)),
