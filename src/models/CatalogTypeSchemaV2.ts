...
import type { CatalogTypeAttributeV2 } from './CatalogTypeAttributeV2';
import {
    CatalogTypeAttributeV2FromJSON,
    CatalogTypeAttributeV2FromJSONTyped,
    CatalogTypeAttributeV2ToJSON,
} from './CatalogTypeAttributeV2';

/**
 * 
 * @export
 * @interface CatalogTypeSchemaV2
 */
export interface CatalogTypeSchemaV2 {
    /**
     * Attributes of this catalog type
     * @type {Array<CatalogTypeAttributeV2>}
     * @memberof CatalogTypeSchemaV2
     */
...
/**
 * Check if a given object implements the CatalogTypeSchemaV2 interface.
 */
export function instanceOfCatalogTypeSchemaV2(value: object): boolean {
    let isInstance = true;
...
export function CatalogTypeSchemaV2FromJSON(json: any): CatalogTypeSchemaV2 {
    return CatalogTypeSchemaV2FromJSONTyped(json, false);
}

export function CatalogTypeSchemaV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogTypeSchemaV2 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'attributes': ((json['attributes'] as Array<any>).map(CatalogTypeAttributeV2FromJSON)),
        'version': json['version'],
    };
}

export function CatalogTypeSchemaV2ToJSON(value?: CatalogTypeSchemaV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'attributes': ((value.attributes as Array<any>).map(CatalogTypeAttributeV2ToJSON)),
