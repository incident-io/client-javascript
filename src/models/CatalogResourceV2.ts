 ...
 * 
 * @export
 * @interface CatalogResourceV2
 */
export interface CatalogResourceV2 {
    /**
     * Which category of resource
     * @type {string}
     * @memberof CatalogResourceV2
     */
    category: CatalogResourceV2CategoryEnum;
    /**
 ...
 * @export
 */
export const CatalogResourceV2CategoryEnum = {
    Primitive: 'primitive',
    Custom: 'custom',
    External: 'external'
} as const;
export type CatalogResourceV2CategoryEnum = typeof CatalogResourceV2CategoryEnum[keyof typeof CatalogResourceV2CategoryEnum];


/**
 * Check if a given object implements the CatalogResourceV2 interface.
 */
export function instanceOfCatalogResourceV2(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "category" in value;
    isInstance = isInstance && "description" in value;
    isInstance = isInstance && "label" in value;
    isInstance = isInstance && "type" in value;
    isInstance = isInstance && "value_docstring" in value;

    return isInstance;
}

export function CatalogResourceV2FromJSON(json: any): CatalogResourceV2 {
    return CatalogResourceV2FromJSONTyped(json, false);
}

export function CatalogResourceV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogResourceV2 {
...
export function CatalogResourceV2ToJSON(value?: CatalogResourceV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
