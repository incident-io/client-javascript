 ...
 * 
 * @export
 * @interface AuditLogPrivateIncidentAccessAttemptedMetadataV2
 */
export interface AuditLogPrivateIncidentAccessAttemptedMetadataV2 {
     ...
     * @type {string}
     * @memberof AuditLogPrivateIncidentAccessAttemptedMetadataV2
     */
    outcome?: AuditLogPrivateIncidentAccessAttemptedMetadataV2OutcomeEnum;
}
 ...
 * @export
 */
export const AuditLogPrivateIncidentAccessAttemptedMetadataV2OutcomeEnum = {
    Granted: 'granted',
    Denied: 'denied'
} as const;
export type AuditLogPrivateIncidentAccessAttemptedMetadataV2OutcomeEnum = typeof AuditLogPrivateIncidentAccessAttemptedMetadataV2OutcomeEnum[keyof typeof AuditLogPrivateIncidentAccessAttemptedMetadataV2OutcomeEnum];


/**
 * Check if a given object implements the AuditLogPrivateIncidentAccessAttemptedMetadataV2 interface.
 */
export function instanceOfAuditLogPrivateIncidentAccessAttemptedMetadataV2(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AuditLogPrivateIncidentAccessAttemptedMetadataV2FromJSON(json: any): AuditLogPrivateIncidentAccessAttemptedMetadataV2 {
    return AuditLogPrivateIncidentAccessAttemptedMetadataV2FromJSONTyped(json, false);
}

export function AuditLogPrivateIncidentAccessAttemptedMetadataV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditLogPrivateIncidentAccessAttemptedMetadataV2 {
...
export function AuditLogPrivateIncidentAccessAttemptedMetadataV2ToJSON(value?: AuditLogPrivateIncidentAccessAttemptedMetadataV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
