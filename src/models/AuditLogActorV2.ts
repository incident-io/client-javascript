...
import type { AuditLogActorMetadataV2 } from './AuditLogActorMetadataV2';
import {
    AuditLogActorMetadataV2FromJSON,
    AuditLogActorMetadataV2FromJSONTyped,
    AuditLogActorMetadataV2ToJSON,
} from './AuditLogActorMetadataV2';

/**
 * 
 * @export
 * @interface AuditLogActorV2
 */
export interface AuditLogActorV2 {
    /**
     * The ID of the actor
     * @type {string}
     * @memberof AuditLogActorV2
     */
    id: string;
    /**
     * 
     * @type {AuditLogActorMetadataV2}
     * @memberof AuditLogActorV2
     */
 ...
 * @export
 */
export const AuditLogActorV2TypeEnum = {
    User: 'user',
    System: 'system',
    ApiKey: 'api_key',
    Workflow: 'workflow',
...
export type AuditLogActorV2TypeEnum = typeof AuditLogActorV2TypeEnum[keyof typeof AuditLogActorV2TypeEnum];


/**
 * Check if a given object implements the AuditLogActorV2 interface.
 */
export function instanceOfAuditLogActorV2(value: object): boolean {
    let isInstance = true;
...
export function AuditLogActorV2FromJSON(json: any): AuditLogActorV2 {
    return AuditLogActorV2FromJSONTyped(json, false);
}

export function AuditLogActorV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditLogActorV2 {
    ...
    return {
        ...
        'id': json['id'],
        'metadata': !exists(json, 'metadata') ? undefined : AuditLogActorMetadataV2FromJSON(json['metadata']),
        'name': !exists(json, 'name') ? undefined : json['name'],
        'type': json['type'],
    };
}

export function AuditLogActorV2ToJSON(value?: AuditLogActorV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'id': value.id,
        'metadata': AuditLogActorMetadataV2ToJSON(value.metadata),
        'name': value.name,
        'type': value.type,
    };
}
