 ...
 * 
 * @export
 * @interface CatalogAttributeValuePayloadV2
 */
export interface CatalogAttributeValuePayloadV2 {
    /**
     * The literal value of this attribute
     * @type {string}
     * @memberof CatalogAttributeValuePayloadV2
     */
    literal?: string;
}

/**
 * Check if a given object implements the CatalogAttributeValuePayloadV2 interface.
 */
export function instanceOfCatalogAttributeValuePayloadV2(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CatalogAttributeValuePayloadV2FromJSON(json: any): CatalogAttributeValuePayloadV2 {
    return CatalogAttributeValuePayloadV2FromJSONTyped(json, false);
}

export function CatalogAttributeValuePayloadV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogAttributeValuePayloadV2 {
...
export function CatalogAttributeValuePayloadV2ToJSON(value?: CatalogAttributeValuePayloadV2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
