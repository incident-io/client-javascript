 ...
 * 
 * @export
 * @interface ShowResponseBody5
 */
export interface ShowResponseBody5 {
    /**
     * 
     * @type {IncidentStatusV1}
     * @memberof ShowResponseBody5
     */
    incident_status: IncidentStatusV1;
}

/**
 * Check if a given object implements the ShowResponseBody5 interface.
 */
export function instanceOfShowResponseBody5(value: object): boolean {
    let isInstance = true;
...
export function ShowResponseBody5FromJSON(json: any): ShowResponseBody5 {
    return ShowResponseBody5FromJSONTyped(json, false);
}

export function ShowResponseBody5FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowResponseBody5 {
...
export function ShowResponseBody5ToJSON(value?: ShowResponseBody5 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
