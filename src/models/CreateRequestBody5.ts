 ...
 * 
 * @export
 * @interface CreateRequestBody5
 */
export interface CreateRequestBody5 {
    /**
     * Whether the status should be considered 'live' or 'closed'. The triage and declined statuses cannot be created or modified.
     * @type {string}
     * @memberof CreateRequestBody5
     */
    category: CreateRequestBody5CategoryEnum;
    /**
 ...
 * @export
 */
export const CreateRequestBody5CategoryEnum = {
    Live: 'live',
    Closed: 'closed'
} as const;
export type CreateRequestBody5CategoryEnum = typeof CreateRequestBody5CategoryEnum[keyof typeof CreateRequestBody5CategoryEnum];


/**
 * Check if a given object implements the CreateRequestBody5 interface.
 */
export function instanceOfCreateRequestBody5(value: object): boolean {
    let isInstance = true;
...
export function CreateRequestBody5FromJSON(json: any): CreateRequestBody5 {
    return CreateRequestBody5FromJSONTyped(json, false);
}

export function CreateRequestBody5FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRequestBody5 {
...
export function CreateRequestBody5ToJSON(value?: CreateRequestBody5 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
