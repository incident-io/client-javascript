...
import {
    ListResponseBody8FromJSON,
    ListResponseBody8ToJSON,
    ShowResponseBody7FromJSON,
    ShowResponseBody7ToJSON,
} from '../models';

export interface IncidentTypesV1ShowRequest {
    id: string;
}
 ...
 * 
 */
export class IncidentTypesV1Api extends runtime.BaseAPI {

    /**
     * List all incident types for an organisation.
     * List Incident Types V1
     */
    async incidentTypesV1ListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListResponseBody8>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListResponseBody8FromJSON(jsonValue));
    }
     ...
     * List Incident Types V1
     */
    async incidentTypesV1List(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListResponseBody8> {
        const response = await this.incidentTypesV1ListRaw(initOverrides);
     ...
     */
    async incidentTypesV1ShowRaw(requestParameters: IncidentTypesV1ShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowResponseBody7>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling incidentTypesV1Show.');
        }
        ...
        const response = await this.request({
            path: `/v1/incident_types/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShowResponseBody7FromJSON(jsonValue));
    }
     ...
     * Show Incident Types V1
     */
    async incidentTypesV1Show(requestParameters: IncidentTypesV1ShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowResponseBody7> {
        const response = await this.incidentTypesV1ShowRaw(requestParameters, initOverrides);
        return await response.value();
    }
