...
import {
    CreateRequestBody8FromJSON,
    CreateRequestBody8ToJSON,
    ListResponseBody12FromJSON,
    ListResponseBody12ToJSON,
    ShowResponseBody10FromJSON,
    ShowResponseBody10ToJSON,
} from '../models';

export interface SeveritiesV1CreateRequest {
    createRequestBody8: CreateRequestBody8;
}
...
export interface SeveritiesV1ShowRequest {
    id: string;
}

export interface SeveritiesV1UpdateRequest {
    id: string;
    createRequestBody8: CreateRequestBody8;
}
 ...
 * 
 */
export class SeveritiesV1Api extends runtime.BaseAPI {

    /**
     * Create a new severity
     * Create Severities V1
     */
    async severitiesV1CreateRaw(requestParameters: SeveritiesV1CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowResponseBody10>> {
        if (requestParameters.createRequestBody8 === null || requestParameters.createRequestBody8 === undefined) {
            throw new runtime.RequiredError('createRequestBody8','Required parameter requestParameters.createRequestBody8 was null or undefined when calling severitiesV1Create.');
        }
        ...
        const response = await this.request({
            ...
            body: CreateRequestBody8ToJSON(requestParameters.createRequestBody8),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShowResponseBody10FromJSON(jsonValue));
    }
     ...
     * Create Severities V1
     */
    async severitiesV1Create(requestParameters: SeveritiesV1CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowResponseBody10> {
        const response = await this.severitiesV1CreateRaw(requestParameters, initOverrides);
     ...
     */
    async severitiesV1DeleteRaw(requestParameters: SeveritiesV1DeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling severitiesV1Delete.');
        }
        ...
        const response = await this.request({
            path: `/v1/severities/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete Severities V1
     */
    async severitiesV1Delete(requestParameters: SeveritiesV1DeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.severitiesV1DeleteRaw(requestParameters, initOverrides);
    }
     ...
     * List Severities V1
     */
    async severitiesV1ListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListResponseBody12>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListResponseBody12FromJSON(jsonValue));
    }
     ...
     * List Severities V1
     */
    async severitiesV1List(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListResponseBody12> {
        const response = await this.severitiesV1ListRaw(initOverrides);
        return await response.value();
    }
     ...
     * Show Severities V1
     */
    async severitiesV1ShowRaw(requestParameters: SeveritiesV1ShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowResponseBody10>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling severitiesV1Show.');
        }
     ...
     * Show Severities V1
     */
    async severitiesV1Show(requestParameters: SeveritiesV1ShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowResponseBody10> {
        const response = await this.severitiesV1ShowRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async severitiesV1UpdateRaw(requestParameters: SeveritiesV1UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowResponseBody10>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling severitiesV1Update.');
        }

        if (requestParameters.createRequestBody8 === null || requestParameters.createRequestBody8 === undefined) {
            throw new runtime.RequiredError('createRequestBody8','Required parameter requestParameters.createRequestBody8 was null or undefined when calling severitiesV1Update.');
        }
     ...
     * Update Severities V1
     */
    async severitiesV1Update(requestParameters: SeveritiesV1UpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowResponseBody10> {
        const response = await this.severitiesV1UpdateRaw(requestParameters, initOverrides);
        return await response.value();
    }
