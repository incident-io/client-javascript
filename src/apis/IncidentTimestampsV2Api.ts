...
import {
    ListResponseBody7FromJSON,
    ListResponseBody7ToJSON,
    ShowResponseBody6FromJSON,
    ShowResponseBody6ToJSON,
} from '../models';
 ...
 * 
 */
export class IncidentTimestampsV2Api extends runtime.BaseAPI {

    /**
     * List all incident timestamps for an organisation.
     * List Incident Timestamps V2
     */
    async incidentTimestampsV2ListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListResponseBody7>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListResponseBody7FromJSON(jsonValue));
    }
     ...
     * List Incident Timestamps V2
     */
    async incidentTimestampsV2List(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListResponseBody7> {
        const response = await this.incidentTimestampsV2ListRaw(initOverrides);
     ...
     */
    async incidentTimestampsV2ShowRaw(requestParameters: IncidentTimestampsV2ShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowResponseBody6>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling incidentTimestampsV2Show.');
        }
        ...
        const response = await this.request({
            path: `/v2/incident_timestamps/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShowResponseBody6FromJSON(jsonValue));
    }
     ...
     * Show Incident Timestamps V2
     */
    async incidentTimestampsV2Show(requestParameters: IncidentTimestampsV2ShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowResponseBody6> {
        const response = await this.incidentTimestampsV2ShowRaw(requestParameters, initOverrides);
        return await response.value();
    }
