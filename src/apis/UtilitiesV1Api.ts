...
import {
    IdentityResponseBodyFromJSON,
    IdentityResponseBodyToJSON,
} from '../models';

/**
 * 
 */
export class UtilitiesV1Api extends runtime.BaseAPI {

    /**
     * Test if your API key is valid, and which roles it has.
     * Identity Utilities V1
     */
    async utilitiesV1IdentityRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IdentityResponseBody>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => IdentityResponseBodyFromJSON(jsonValue));
    }
     ...
     * Identity Utilities V1
     */
    async utilitiesV1Identity(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IdentityResponseBody> {
        const response = await this.utilitiesV1IdentityRaw(initOverrides);
     ...
     */
    async utilitiesV1OpenAPIRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        const queryParameters: any = {};
     ...
     * OpenAPI Utilities V1
     */
    async utilitiesV1OpenAPI(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.utilitiesV1OpenAPIRaw(initOverrides);
        return await response.value();
    }
