...
import {
    ListResponseBody9FromJSON,
    ListResponseBody9ToJSON,
} from '../models';
 ...
 * 
 */
export class IncidentUpdatesV2Api extends runtime.BaseAPI {

    /**
     * List all incident updates for an organisation, or for a specific incident.
     * List Incident Updates V2
     */
    async incidentUpdatesV2ListRaw(requestParameters: IncidentUpdatesV2ListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListResponseBody9>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListResponseBody9FromJSON(jsonValue));
    }
     ...
     * List Incident Updates V2
     */
    async incidentUpdatesV2List(requestParameters: IncidentUpdatesV2ListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListResponseBody9> {
        const response = await this.incidentUpdatesV2ListRaw(requestParameters, initOverrides);
